...
// NewCustomerFeedServiceInterface creates an initializes a CustomerFeedServiceInterface.
func NewCustomerFeedServiceInterface(cli *soap.Client) CustomerFeedServiceInterface {
	return &customerFeedServiceInterface{cli}
}

// CustomerFeedServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type CustomerFeedServiceInterface interface {
	// Returns a list of customer feeds that meet the selector criteria.
	//                  @param selector Determines which customer feeds
	// to return. If empty, all         customer feeds are returned.
	//         @return The list of customer feeds.         @throws
	// ApiException Indicates a problem with the request.
	Get(Get *Get) (*GetResponse, error)

	// Adds, sets, or removes customer feeds.                  @param
	...
	//        @return A list of CustomerFeed.         @throws ApiException
	// If problems occur while parsing the query or fetching CustomerFeed.
...
// CustomerFeedStatus was auto-generated from WSDL.
type CustomerFeedStatus string

// Validate validates CustomerFeedStatus.
func (v CustomerFeedStatus) Validate() bool {
	for _, vv := range []string{
		"ENABLED",
		"REMOVED",
		"UNKNOWN",
...
// CustomerFeedErrorReason was auto-generated from WSDL.
type CustomerFeedErrorReason string

// Validate validates CustomerFeedErrorReason.
func (v CustomerFeedErrorReason) Validate() bool {
	for _, vv := range []string{
...
// CustomerFeeds are used to link a feed to the customer using
// a matching function,             making the feed's feed items
// available in the customer's ads for substitution.
type CustomerFeed struct {
	...
	Status           *CustomerFeedStatus `xml:"status,omitempty" json:"status,omitempty" yaml:"status,omitempty"`
}
...
type CustomerFeedError struct {
	...
	ErrorString       *string                  `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string                  `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *CustomerFeedErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string                   `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string                   `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CustomerFeedError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CustomerFeedError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type CustomerFeedOperation struct {
	...
	Operand       *CustomerFeed `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string        `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string        `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CustomerFeedOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CustomerFeedOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// a list of             associations between customer and feeds.
type CustomerFeedPage struct {
	...
	Entries         []*CustomerFeed `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string          `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string          `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CustomerFeedPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CustomerFeedPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type CustomerFeedReturnValue struct {
	...
	Value               []*CustomerFeed `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
	TypeAttrXSI         string          `xml:"xsi:type,attr,omitempty"`
	TypeNamespace       string          `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CustomerFeedReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CustomerFeedReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *CustomerFeedPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*CustomerFeedOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *CustomerFeedReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// customerFeedServiceInterface implements the CustomerFeedServiceInterface interface.
...
//         @return The list of customer feeds.         @throws
// ApiException Indicates a problem with the request.
func (p *customerFeedServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// feeds.         @throws ApiException Indicates a problem with
// the request.
func (p *customerFeedServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
//        @return A list of CustomerFeed.         @throws ApiException
// If problems occur while parsing the query or fetching CustomerFeed.
func (p *customerFeedServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
