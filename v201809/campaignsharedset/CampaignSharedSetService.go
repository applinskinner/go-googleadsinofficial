...
// NewCampaignSharedSetServiceInterface creates an initializes a CampaignSharedSetServiceInterface.
func NewCampaignSharedSetServiceInterface(cli *soap.Client) CampaignSharedSetServiceInterface {
	return &campaignSharedSetServiceInterface{cli}
}

// CampaignSharedSetServiceInterface was auto-generated from WSDL
...
type CampaignSharedSetServiceInterface interface {
	...
	//       @return a list of CampaignSharedSet entities that meet
	// the criterion specified         by the selector         @throws
	// ApiException
	Get(Get *Get) (*GetResponse, error)

	// Applies the list of mutate operations.         @param operations
	// the operations to apply         @return the modified list of
	// CampaignSharedSet associations         @throws ApiException
	Mutate(Mutate *Mutate) (*MutateResponse, error)

	// Returns the list of CampaignSharedSets that match the query.
	//                  @param query The SQL-like AWQL query string
	//         @returns A list of CampaignSharedSets         @throws
...
// CampaignSharedSetStatus was auto-generated from WSDL.
type CampaignSharedSetStatus string

// Validate validates CampaignSharedSetStatus.
func (v CampaignSharedSetStatus) Validate() bool {
	for _, vv := range []string{
		"ENABLED",
		"REMOVED",
		"UNKNOWN",
...
type CampaignSharedSet struct {
	...
	SharedSetName *string                  `xml:"sharedSetName,omitempty" json:"sharedSetName,omitempty" yaml:"sharedSetName,omitempty"`
	SharedSetType *SharedSetType           `xml:"sharedSetType,omitempty" json:"sharedSetType,omitempty" yaml:"sharedSetType,omitempty"`
	CampaignName  *string                  `xml:"campaignName,omitempty" json:"campaignName,omitempty" yaml:"campaignName,omitempty"`
	Status        *CampaignSharedSetStatus `xml:"status,omitempty" json:"status,omitempty" yaml:"status,omitempty"`
}
...
type CampaignSharedSetOperation struct {
	...
	Operand       *CampaignSharedSet `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string             `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string             `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignSharedSetOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignSharedSetOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// Contains a list of associations between campaigns and shared
// sets             resulting from the filtering and paging of
...
type CampaignSharedSetPage struct {
	...
	Entries         []*CampaignSharedSet `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string               `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string               `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignSharedSetPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignSharedSetPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type CampaignSharedSetReturnValue struct {
	...
	Value                []*CampaignSharedSet `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignSharedSetReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignSharedSetReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *CampaignSharedSetPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*CampaignSharedSetOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *CampaignSharedSetReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// campaignSharedSetServiceInterface implements the CampaignSharedSetServiceInterface interface.
...
// the criterion specified         by the selector         @throws
// ApiException
func (p *campaignSharedSetServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// the operations to apply         @return the modified list of
// CampaignSharedSet associations         @throws ApiException
func (p *campaignSharedSetServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// ApiException when the query is invalid or there are errors processing
// the request.
func (p *campaignSharedSetServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
