...
// NewBatchJobServiceInterface creates an initializes a BatchJobServiceInterface.
func NewBatchJobServiceInterface(cli *soap.Client) BatchJobServiceInterface {
	return &batchJobServiceInterface{cli}
}

// BatchJobServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type BatchJobServiceInterface interface {
	// Query the status of existing {@code BatchJob}s.
	//      @param selector The selector specifying the {@code BatchJob}s
	// to return.         @return The list of selected jobs.
	//   @throws ApiException
	Get(Get *Get) (*GetResponse, error)

	// Creates or updates a {@code BatchJob}.                  <p class="note"><b>Note:</b>
	// {@link BatchJobOperation} does not support the         {@code
	// REMOVE} operator. It is not necessary to remove BatchJobs.
	//                 @param operations A list of operations.
	//     @return The list of created or updated jobs.         @throws
	// ApiException
	Mutate(Mutate *Mutate) (*MutateResponse, error)

	// Returns the list of {@code BatchJob}s that match the query.
	//                  @param query The SQL-like AWQL query string.
	//         @return The list of selected jobs.         @throws ApiException
	// if problems occur while parsing the query or fetching
...
// BatchJobErrorReason was auto-generated from WSDL.
type BatchJobErrorReason string

// Validate validates BatchJobErrorReason.
func (v BatchJobErrorReason) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
		"DISK_QUOTA_EXCEEDED",
...
// BatchJobProcessingErrorReason was auto-generated from WSDL.
type BatchJobProcessingErrorReason string

// Validate validates BatchJobProcessingErrorReason.
func (v BatchJobProcessingErrorReason) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
...
// BatchJobStatus was auto-generated from WSDL.
type BatchJobStatus string

// Validate validates BatchJobStatus.
func (v BatchJobStatus) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
		"AWAITING_FILE",
		"ACTIVE",
...
type BatchJob struct {
	...
	Status                *BatchJobStatus            `xml:"status,omitempty" json:"status,omitempty" yaml:"status,omitempty"`
	ProgressStats         *ProgressStats             `xml:"progressStats,omitempty" json:"progressStats,omitempty" yaml:"progressStats,omitempty"`
	UploadUrl             *TemporaryUrl              `xml:"uploadUrl,omitempty" json:"uploadUrl,omitempty" yaml:"uploadUrl,omitempty"`
	DownloadUrl           *TemporaryUrl              `xml:"downloadUrl,omitempty" json:"downloadUrl,omitempty" yaml:"downloadUrl,omitempty"`
	ProcessingErrors      []*BatchJobProcessingError `xml:"processingErrors,omitempty" json:"processingErrors,omitempty" yaml:"processingErrors,omitempty"`
	DiskUsageQuotaBalance *int64                     `xml:"diskUsageQuotaBalance,omitempty" json:"diskUsageQuotaBalance,omitempty" yaml:"diskUsageQuotaBalance,omitempty"`
}
...
type BatchJobError struct {
	...
	ErrorString       *string              `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string              `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *BatchJobErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string               `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string               `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *BatchJobError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:BatchJobError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
//  <p class="note"><b>Note:</b> Only the <code>ADD</code> and
// <code>SET</code>             operators are supported.
type BatchJobOperation struct {
	...
	Operand       *BatchJob `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string    `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string    `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *BatchJobOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:BatchJobOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type BatchJobPage struct {
	...
	Entries         []*BatchJob `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string      `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string      `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *BatchJobPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:BatchJobPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type BatchJobProcessingError struct {
	...
	ErrorString       *string                        `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string                        `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *BatchJobProcessingErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string                         `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string                         `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *BatchJobProcessingError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:BatchJobProcessingError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type BatchJobReturnValue struct {
	...
	Value               []*BatchJob `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
	TypeAttrXSI         string      `xml:"xsi:type,attr,omitempty"`
	TypeNamespace       string      `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *BatchJobReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:BatchJobReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type ProgressStats struct {
	NumOperationsExecuted    *int64 `xml:"numOperationsExecuted,omitempty" json:"numOperationsExecuted,omitempty" yaml:"numOperationsExecuted,omitempty"`
	NumOperationsSucceeded   *int64 `xml:"numOperationsSucceeded,omitempty" json:"numOperationsSucceeded,omitempty" yaml:"numOperationsSucceeded,omitempty"`
	EstimatedPercentExecuted *int   `xml:"estimatedPercentExecuted,omitempty" json:"estimatedPercentExecuted,omitempty" yaml:"estimatedPercentExecuted,omitempty"`
	NumResultsWritten        *int64 `xml:"numResultsWritten,omitempty" json:"numResultsWritten,omitempty" yaml:"numResultsWritten,omitempty"`
}
...
type TemporaryUrl struct {
	...
	Expiration *string `xml:"expiration,omitempty" json:"expiration,omitempty" yaml:"expiration,omitempty"`
}
...
type GetResponse struct {
	Rval *BatchJobPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*BatchJobOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *BatchJobReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// batchJobServiceInterface implements the BatchJobServiceInterface interface.
...
// to return.         @return The list of selected jobs.
//   @throws ApiException
func (p *batchJobServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
//     @return The list of created or updated jobs.         @throws
// ApiException
func (p *batchJobServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// if problems occur while parsing the query or fetching
//   batchjob information.
func (p *batchJobServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
