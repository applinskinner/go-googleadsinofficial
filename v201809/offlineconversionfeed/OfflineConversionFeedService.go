...
// NewOfflineConversionFeedServiceInterface creates an initializes a OfflineConversionFeedServiceInterface.
func NewOfflineConversionFeedServiceInterface(cli *soap.Client) OfflineConversionFeedServiceInterface {
	return &offlineConversionFeedServiceInterface{cli}
}

// OfflineConversionFeedServiceInterface was auto-generated from WSDL
...
type OfflineConversionFeedServiceInterface interface {
	...
	// fail.                  <p><b>Note:</b> {@link OfflineConversionFeedOperation}
	// supports only the         {@code ADD} operator. ({@code SET}
	// and {@code REMOVE} are not supported.)                  @param
	// operations A list of offline conversion feed operations.
	//      @return The list of offline conversion feed results (in
	// the same order as the operations).         @throws {@link ApiException}
	// if problems occurred while applying offline conversions.
...
// Represents an entire record in the offline conversions feed
// that the advertiser uploads.
type OfflineConversionFeed struct {
	GoogleClickId             *string  `xml:"googleClickId,omitempty" json:"googleClickId,omitempty" yaml:"googleClickId,omitempty"`
	...
	ExternalAttributionCredit *float64 `xml:"externalAttributionCredit,omitempty" json:"externalAttributionCredit,omitempty" yaml:"externalAttributionCredit,omitempty"`
	ExternalAttributionModel  *string  `xml:"externalAttributionModel,omitempty" json:"externalAttributionModel,omitempty" yaml:"externalAttributionModel,omitempty"`
}

// Operation for uploading {@link OfflineConversionFeed}.
//        See {@link OfflineConversionFeedService#mutate}.
//                      <p><b>Note:</b> Only the {@code ADD} operator
// is supported.
type OfflineConversionFeedOperation struct {
	...
	Operand       *OfflineConversionFeed `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string                 `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string                 `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *OfflineConversionFeedOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:OfflineConversionFeedOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type OfflineConversionFeedReturnValue struct {
	...
	Value                []*OfflineConversionFeed `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *OfflineConversionFeedReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:OfflineConversionFeedReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type Mutate struct {
	Operations []*OfflineConversionFeedOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *OfflineConversionFeedReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// offlineConversionFeedServiceInterface implements the OfflineConversionFeedServiceInterface interface.
...
// the same order as the operations).         @throws {@link ApiException}
// if problems occurred while applying offline conversions.
func (p *offlineConversionFeedServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
