...
// NewBiddingStrategyServiceInterface creates an initializes a BiddingStrategyServiceInterface.
func NewBiddingStrategyServiceInterface(cli *soap.Client) BiddingStrategyServiceInterface {
	return &biddingStrategyServiceInterface{cli}
}

// BiddingStrategyServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type BiddingStrategyServiceInterface interface {
	// Returns a list of bidding strategies that match the selector.
	//                  @return list of bidding strategies specified
	// by the selector.         @throws com.google.ads.api.services.common.error.ApiException
	...
	// list of BiddingStrategy         @throws ApiException
...
// BiddingStrategyErrorReason was auto-generated from WSDL.
type BiddingStrategyErrorReason string

// Validate validates BiddingStrategyErrorReason.
func (v BiddingStrategyErrorReason) Validate() bool {
	for _, vv := range []string{
		"DUPLICATE_NAME",
...
// SharedBiddingStrategyBiddingStrategyStatus was auto-generated
// from WSDL.
type SharedBiddingStrategyBiddingStrategyStatus string

// Validate validates SharedBiddingStrategyBiddingStrategyStatus.
func (v SharedBiddingStrategyBiddingStrategyStatus) Validate() bool {
	for _, vv := range []string{
		"ENABLED",
		"REMOVED",
		"UNKNOWN",
...
type BiddingStrategyError struct {
	...
	ErrorString       *string                     `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string                     `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *BiddingStrategyErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string                      `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string                      `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *BiddingStrategyError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:BiddingStrategyError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type BiddingStrategyOperation struct {
	...
	Operand       *SharedBiddingStrategy `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string                 `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string                 `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *BiddingStrategyOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:BiddingStrategyOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// and paging             of {@link BiddingStrategy#get} call.
type BiddingStrategyPage struct {
	...
	Entries         []*SharedBiddingStrategy `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string                   `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string                   `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *BiddingStrategyPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:BiddingStrategyPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type BiddingStrategyReturnValue struct {
	...
	Value               []*SharedBiddingStrategy `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
	TypeAttrXSI         string                   `xml:"xsi:type,attr,omitempty"`
	TypeNamespace       string                   `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *BiddingStrategyReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:BiddingStrategyReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type SharedBiddingStrategy struct {
	...
	Status        *SharedBiddingStrategyBiddingStrategyStatus `xml:"status,omitempty" json:"status,omitempty" yaml:"status,omitempty"`
	Type          *BiddingStrategyType                        `xml:"type,omitempty" json:"type,omitempty" yaml:"type,omitempty"`
}
...
type GetResponse struct {
	Rval *BiddingStrategyPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*BiddingStrategyOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *BiddingStrategyReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// biddingStrategyServiceInterface implements the BiddingStrategyServiceInterface interface.
...
// by the selector.         @throws com.google.ads.api.services.common.error.ApiException
// if problems         occurred while retrieving results.
func (p *biddingStrategyServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// operations the operations to apply         @return the modified
// list of BiddingStrategy         @throws ApiException
func (p *biddingStrategyServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
//         @throws ApiException when there are one or more errors
// with the request.
func (p *biddingStrategyServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
