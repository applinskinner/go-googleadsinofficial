package customernegativecriterion
...
// NewCustomerNegativeCriterionServiceInterface creates an initializes a CustomerNegativeCriterionServiceInterface.
func NewCustomerNegativeCriterionServiceInterface(cli *soap.Client) CustomerNegativeCriterionServiceInterface {
	return &customerNegativeCriterionServiceInterface{cli}
}

// CustomerNegativeCriterionServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type CustomerNegativeCriterionServiceInterface interface {
	// Returns a list of CustomerNegativeCriterion that meets the selector
	// criteria                  @param selector filters the criteria
	// returned         @return The list of CustomerNegativeCriterion
	//         @throws ApiException
	Get(Get *Get) (*GetResponse, error)

	// Adds, removes negative criteria for a customer. These negative
	// criteria apply to all         campaigns of the customer.
	...
	// query.                  @param query The SQL-like AWQL query
	// string.         @return A list of CustomerNegativeCriterion.
	//         @throws ApiException
...
// CustomerNegativeCriterionErrorReason was auto-generated from
// WSDL.
type CustomerNegativeCriterionErrorReason string

// Validate validates CustomerNegativeCriterionErrorReason.
func (v CustomerNegativeCriterionErrorReason) Validate() bool {
	for _, vv := range []string{
...
type CustomerNegativeCriterionError struct {
	...
	ErrorString       *string                               `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string                               `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *CustomerNegativeCriterionErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string                                `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string                                `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CustomerNegativeCriterionError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CustomerNegativeCriterionError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type CustomerNegativeCriterionOperation struct {
	...
	Operand       *CustomerNegativeCriterion `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string                     `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string                     `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CustomerNegativeCriterionOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CustomerNegativeCriterionOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// and sorted             as specified in the {@link CustomerExclusionCriterionService#get}
// call
type CustomerNegativeCriterionPage struct {
	...
	Entries         []*CustomerNegativeCriterion `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string                       `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string                       `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CustomerNegativeCriterionPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CustomerNegativeCriterionPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type CustomerNegativeCriterionReturnValue struct {
	...
	Value               []*CustomerNegativeCriterion `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
	TypeAttrXSI         string                       `xml:"xsi:type,attr,omitempty"`
	TypeNamespace       string                       `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CustomerNegativeCriterionReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CustomerNegativeCriterionReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// YouTube channel criterion.             <p>             <span
...
// YouTube video criterion.             <p>             <span class="constraint
...
type GetResponse struct {
	Rval *CustomerNegativeCriterionPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*CustomerNegativeCriterionOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *CustomerNegativeCriterionReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// customerNegativeCriterionServiceInterface implements the CustomerNegativeCriterionServiceInterface interface.
...
// returned         @return The list of CustomerNegativeCriterion
//         @throws ApiException
func (p *customerNegativeCriterionServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
//               @param operations A list of operations to apply
//         @throws ApiException
func (p *customerNegativeCriterionServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// string.         @return A list of CustomerNegativeCriterion.
//         @throws ApiException
func (p *customerNegativeCriterionServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
