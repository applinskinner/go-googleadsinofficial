...
// NewAccountLabelServiceInterface creates an initializes a AccountLabelServiceInterface.
func NewAccountLabelServiceInterface(cli *soap.Client) AccountLabelServiceInterface {
	return &accountLabelServiceInterface{cli}
}

// AccountLabelServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type AccountLabelServiceInterface interface {
	// Returns a list of labels specified by the selector for the authenticated
	// user.                  @param selector filters the list of labels
	// to return         @return response containing lists of labels
	// that meet all the criteria of the selector         @throws ApiException
	// if a problem occurs fetching the information requested
	Get(Get *Get) (*GetResponse, error)

	// Possible actions:         <ul>         <li> Create a new label
	// - create a new {@link Label} and call mutate with ADD operator
	//         <li> Edit the label name - set the appropriate fields
	// in your {@linkplain Label} and call         mutate with the
	// SET operator. Null fields will be interpreted to mean "no change"
	//         <li> Delete the label - call mutate with REMOVE operator
	//         </ul>                  @param operations list of unique
	// operations to be executed in a single transaction, in the
	//       order specified.         @return the mutated labels, in
	// the same order that they were in as the parameter         @throws
	// ApiException if problems occurs while modifying label information
...
// LabelServiceErrorReason was auto-generated from WSDL.
type LabelServiceErrorReason string

// Validate validates LabelServiceErrorReason.
func (v LabelServiceErrorReason) Validate() bool {
	for _, vv := range []string{
		"EMPTY_LABEL_NAME",
		"LABEL_NAME_TOO_LONG",
...
type AccountLabelOperation struct {
	...
	Operand       *AccountLabel `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
...
func (t *AccountLabelOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:AccountLabelOperation"
	}
...
type AccountLabelPage struct {
	Labels []*AccountLabel `xml:"labels,omitempty" json:"labels,omitempty" yaml:"labels,omitempty"`
}
...
type LabelServiceError struct {
	...
	ErrorString       *string                  `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string                  `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *LabelServiceErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string                   `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string                   `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *LabelServiceError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:LabelServiceError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *AccountLabelPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*AccountLabelOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *AccountLabelReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// accountLabelServiceInterface implements the AccountLabelServiceInterface interface.
...
// that meet all the criteria of the selector         @throws ApiException
// if a problem occurs fetching the information requested
func (p *accountLabelServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// the same order that they were in as the parameter         @throws
// ApiException if problems occurs while modifying label information
func (p *accountLabelServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
