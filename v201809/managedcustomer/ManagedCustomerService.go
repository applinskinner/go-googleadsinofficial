...
var Namespace = "https://adwords.google.com/api/adwords/mcm/v201809"

// NewManagedCustomerServiceInterface creates an initializes a ManagedCustomerServiceInterface.
func NewManagedCustomerServiceInterface(cli *soap.Client) ManagedCustomerServiceInterface {
	return &managedCustomerServiceInterface{cli}
}

// ManagedCustomerServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type ManagedCustomerServiceInterface interface {
	// Returns the list of customers that meet the selector criteria.
	//                  @param selector The selector specifying the
	// {@link ManagedCustomer}s to return.         @return List of
	// customers identified by the selector.         @throws ApiException
	...
	// selector.         @param selector the manager customer ids (inviters)
	// or the client customer ids (invitees)         @throws ApiException
	// when there is at least one error with the request
	GetPendingInvitations(GetPendingInvitations *GetPendingInvitations) (*GetPendingInvitationsResponse, error)

	// Modifies or creates new {@link ManagedCustomer}s.
	//        <p class="note"><b>Note:</b> See {@link ManagedCustomerOperation}
	// for available operators.</p>                  @param operations
	// List of unique operations.         @return The list of updated
	// managed customers, returned in the same order as the
	//  <code>operations</code> array.
	Mutate(Mutate *Mutate) (*MutateResponse, error)

	// Adds {@linkplain AccountLabel}s to, and removes         {@linkplain
	// AccountLabel}s from, {@linkplain ManagedCustomer}s.
	//          <p>To add an {@linkplain AccountLabel} to a {@linkplain
	// ManagedCustomer},         use {@link Operator#ADD}.
	// To remove an {@linkplain AccountLabel} from a {@linkplain ManagedCustomer},
	//         use {@link Operator#REMOVE}.</p>         <p>The label
	// must already exist (see {@link AccountLabelService#mutate} for
	//         how to create them) and be owned by the authenticated
	// user.</p>         <p>The {@linkplain ManagedCustomer} must already
	// exist and be managed by         the customer making the request
	// (either directly or indirectly).</p>         <p>An AccountLabel
	// may be applied to at most 1000 customers.</p>         <p>This
	// method does not support partial failures, and will fail if any
	...
	// (categorized by         Operator + Link Status):
	//       <ul>         <li>ADD + PENDING:   manager extends invitations</li>
	...
	//         </ul>                  In addition to these, active
	// links can also be marked hidden / unhidden.         <ul>
	//      <li> An ACTIVE link can be marked hidden with SET + ACTIVE
	// along with setting the         isHidden bit to true. </li>
	//        <li> An ACTIVE link can be marked unhidden with SET +
	// ACTIVE along with setting the         isHidden bit to false.
	// </li>         </ul>                  @param operations the list
	// of operations         @return results for the given operations
	//         @throws ApiException with a {@link ManagedCustomerServiceError}
	MutateLink(MutateLink *MutateLink) (*MutateLinkResponse, error)

	// Moves client customers to new managers (moving links). Only
	// the following action is possible:                  <ul>
	//     <li>SET + ACTIVE: manager moves client customers to new
	// managers within the same manager         account hierarchy</li>
	//         </ul>                  @param operations List of unique
	// operations.         @return results for the given operations
	//         @throws ApiException with a {@link ManagedCustomerServiceError}
	MutateManager(MutateManager *MutateManager) (*MutateManagerResponse, error)
}

// AccessRole was auto-generated from WSDL.
type AccessRole string

// Validate validates AccessRole.
func (v AccessRole) Validate() bool {
...
// LinkStatus was auto-generated from WSDL.
type LinkStatus string

// Validate validates LinkStatus.
func (v LinkStatus) Validate() bool {
	for _, vv := range []string{
		"ACTIVE",
		"INACTIVE",
		"PENDING",
...
// ManagedCustomerServiceErrorReason was auto-generated from WSDL.
type ManagedCustomerServiceErrorReason string

// Validate validates ManagedCustomerServiceErrorReason.
func (v ManagedCustomerServiceErrorReason) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
		"NOT_AUTHORIZED",
		"INVALID_SELECTOR",
...
// A label that can be attached to accounts.             A manager
// may attach labels to accounts that s/he manages
// (either directly or indirectly).                          <p>Note
// that these are not interchangeable with campaign management
// labels, and are owned             by manager customers.
...
func (t *ApiException) SetXMLType() {
	...
	if t.OverrideTypeNamespace != nil {
		...
		t.TypeNamespace = "https://adwords.google.com/api/adwords/mcm/v201809"
	}
}
...
type LinkOperation struct {
	...
	Operand       *ManagedCustomerLink `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string               `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string               `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *LinkOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:LinkOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type ManagedCustomer struct {
	Name                  *string         `xml:"name,omitempty" json:"name,omitempty" yaml:"name,omitempty"`
	CustomerId            *int64          `xml:"customerId,omitempty" json:"customerId,omitempty" yaml:"customerId,omitempty"`
	CanManageClients      *bool           `xml:"canManageClients,omitempty" json:"canManageClients,omitempty" yaml:"canManageClients,omitempty"`
	CurrencyCode          *string         `xml:"currencyCode,omitempty" json:"currencyCode,omitempty" yaml:"currencyCode,omitempty"`
	DateTimeZone          *string         `xml:"dateTimeZone,omitempty" json:"dateTimeZone,omitempty" yaml:"dateTimeZone,omitempty"`
	TestAccount           *bool           `xml:"testAccount,omitempty" json:"testAccount,omitempty" yaml:"testAccount,omitempty"`
	AccountLabels         []*AccountLabel `xml:"accountLabels,omitempty" json:"accountLabels,omitempty" yaml:"accountLabels,omitempty"`
	ExcludeHiddenAccounts *bool           `xml:"excludeHiddenAccounts,omitempty" json:"excludeHiddenAccounts,omitempty" yaml:"excludeHiddenAccounts,omitempty"`
}
...
// customer.                          <p class="note"><b>Note:</b>
// The {@code SET} operator is not supported.</p>
type ManagedCustomerLabelOperation struct {
	Operator      *Operator             `xml:"operator,omitempty" json:"operator,omitempty" yaml:"operator,omitempty"`
	OperationType *string               `xml:"Operation.Type,omitempty" json:"Operation.Type,omitempty" yaml:"Operation.Type,omitempty"`
	Operand       *ManagedCustomerLabel `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string                `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string                `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *ManagedCustomerLabelOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:ManagedCustomerLabelOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
//             <p>For successful {@linkplain ADD} operations, the
// input {@linkplain ManagedCustomerLabel}             is returned.
//             <p>For successful {@linkplain REMOVE} operations,
// the returned {@linkplain ManagedCustomerLabel}             will
// contain the customer ID and a null label ID.
type ManagedCustomerLabelReturnValue struct {
	Value []*ManagedCustomerLabel `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
}

// Represents an AdWords manager-client link.
type ManagedCustomerLink struct {
	ManagerCustomerId      *int64      `xml:"managerCustomerId,omitempty" json:"managerCustomerId,omitempty" yaml:"managerCustomerId,omitempty"`
	ClientCustomerId       *int64      `xml:"clientCustomerId,omitempty" json:"clientCustomerId,omitempty" yaml:"clientCustomerId,omitempty"`
	LinkStatus             *LinkStatus `xml:"linkStatus,omitempty" json:"linkStatus,omitempty" yaml:"linkStatus,omitempty"`
	PendingDescriptiveName *string     `xml:"pendingDescriptiveName,omitempty" json:"pendingDescriptiveName,omitempty" yaml:"pendingDescriptiveName,omitempty"`
...
//                   <p><b>Note:</b> The {@code REMOVE} operator
// is not supported.
type ManagedCustomerOperation struct {
	Operator      *Operator        `xml:"operator,omitempty" json:"operator,omitempty" yaml:"operator,omitempty"`
	OperationType *string          `xml:"Operation.Type,omitempty" json:"Operation.Type,omitempty" yaml:"Operation.Type,omitempty"`
	Operand       *ManagedCustomer `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	InviteeEmail  *string          `xml:"inviteeEmail,omitempty" json:"inviteeEmail,omitempty" yaml:"inviteeEmail,omitempty"`
	InviteeRole   *AccessRole      `xml:"inviteeRole,omitempty" json:"inviteeRole,omitempty" yaml:"inviteeRole,omitempty"`
	TypeAttrXSI   string           `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string           `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *ManagedCustomerOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:ManagedCustomerOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type ManagedCustomerPage struct {
	...
	Entries         []*ManagedCustomer     `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	Links           []*ManagedCustomerLink `xml:"links,omitempty" json:"links,omitempty" yaml:"links,omitempty"`
	TypeAttrXSI     string                 `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string                 `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *ManagedCustomerPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:ManagedCustomerPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type ManagedCustomerReturnValue struct {
	Value []*ManagedCustomer `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
}
...
type ManagedCustomerServiceError struct {
	...
	ErrorString       *string                            `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string                            `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *ManagedCustomerServiceErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	CustomerIds       []*int64                           `xml:"customerIds,omitempty" json:"customerIds,omitempty" yaml:"customerIds,omitempty"`
	TypeAttrXSI       string                             `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string                             `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *ManagedCustomerServiceError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:ManagedCustomerServiceError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type MoveOperation struct {
	...
	OperationType        *string              `xml:"Operation.Type,omitempty" json:"Operation.Type,omitempty" yaml:"Operation.Type,omitempty"`
	Operand              *ManagedCustomerLink `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	OldManagerCustomerId *int64               `xml:"oldManagerCustomerId,omitempty" json:"oldManagerCustomerId,omitempty" yaml:"oldManagerCustomerId,omitempty"`
	TypeAttrXSI          string               `xml:"xsi:type,attr,omitempty"`
	TypeNamespace        string               `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *MoveOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:MoveOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// Results of a {@link ManagedCustomerService#mutateLink} call
// which changes             manager/client links.
type MutateLinkResults struct {
	Links []*ManagedCustomerLink `xml:"links,omitempty" json:"links,omitempty" yaml:"links,omitempty"`
}

// Results of a {@link ManagedCustomerService#mutateManager} call,
// which moves client customers to             new managers.
...
type PendingInvitation struct {
	Manager        *ManagedCustomer `xml:"manager,omitempty" json:"manager,omitempty" yaml:"manager,omitempty"`
	Client         *ManagedCustomer `xml:"client,omitempty" json:"client,omitempty" yaml:"client,omitempty"`
	CreationDate   *string          `xml:"creationDate,omitempty" json:"creationDate,omitempty" yaml:"creationDate,omitempty"`
	ExpirationDate *string          `xml:"expirationDate,omitempty" json:"expirationDate,omitempty" yaml:"expirationDate,omitempty"`
}

// Selector for getPendingInvitations method.
type PendingInvitationSelector struct {
	ManagerCustomerIds []*int64 `xml:"managerCustomerIds,omitempty" json:"managerCustomerIds,omitempty" yaml:"managerCustomerIds,omitempty"`
	ClientCustomerIds  []*int64 `xml:"clientCustomerIds,omitempty" json:"clientCustomerIds,omitempty" yaml:"clientCustomerIds,omitempty"`
}
...
// GetPendingInvitations was auto-generated from WSDL.
type GetPendingInvitations struct {
	Selector *PendingInvitationSelector `xml:"selector,omitempty" json:"selector,omitempty" yaml:"selector,omitempty"`
}

// GetPendingInvitationsResponse was auto-generated from WSDL.
type GetPendingInvitationsResponse struct {
	Rval []*PendingInvitation `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// GetResponse was auto-generated from WSDL.
type GetResponse struct {
	Rval *ManagedCustomerPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*ManagedCustomerOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateLabel was auto-generated from WSDL.
type MutateLabel struct {
	Operations []*ManagedCustomerLabelOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateLabelResponse was auto-generated from WSDL.
type MutateLabelResponse struct {
	Rval *ManagedCustomerLabelReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// MutateLink was auto-generated from WSDL.
type MutateLink struct {
	Operations []*LinkOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateLinkResponse was auto-generated from WSDL.
type MutateLinkResponse struct {
	Rval *MutateLinkResults `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// MutateManager was auto-generated from WSDL.
type MutateManager struct {
	Operations []*MoveOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateManagerResponse was auto-generated from WSDL.
type MutateManagerResponse struct {
	Rval *MutateManagerResults `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *ManagedCustomerReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// Operation wrapper for GetPendingInvitations.
// OperationGetPendingInvitationsRequest was auto-generated from
// WSDL.
type OperationGetPendingInvitationsRequest struct {
	GetPendingInvitations *GetPendingInvitations `xml:"getPendingInvitations,omitempty" json:"getPendingInvitations,omitempty" yaml:"getPendingInvitations,omitempty"`
}

// Operation wrapper for GetPendingInvitations.
// OperationGetPendingInvitationsResponse was auto-generated from
// WSDL.
type OperationGetPendingInvitationsResponse struct {
	GetPendingInvitationsResponse *GetPendingInvitationsResponse `xml:"getPendingInvitationsResponse,omitempty" json:"getPendingInvitationsResponse,omitempty" yaml:"getPendingInvitationsResponse,omitempty"`
}
...
// Operation wrapper for MutateLink.
// OperationMutateLinkRequest was auto-generated from WSDL.
type OperationMutateLinkRequest struct {
	MutateLink *MutateLink `xml:"mutateLink,omitempty" json:"mutateLink,omitempty" yaml:"mutateLink,omitempty"`
}

// Operation wrapper for MutateLink.
// OperationMutateLinkResponse was auto-generated from WSDL.
type OperationMutateLinkResponse struct {
	MutateLinkResponse *MutateLinkResponse `xml:"mutateLinkResponse,omitempty" json:"mutateLinkResponse,omitempty" yaml:"mutateLinkResponse,omitempty"`
}

// Operation wrapper for MutateManager.
// OperationMutateManagerRequest was auto-generated from WSDL.
type OperationMutateManagerRequest struct {
	MutateManager *MutateManager `xml:"mutateManager,omitempty" json:"mutateManager,omitempty" yaml:"mutateManager,omitempty"`
}

// Operation wrapper for MutateManager.
// OperationMutateManagerResponse was auto-generated from WSDL.
type OperationMutateManagerResponse struct {
	MutateManagerResponse *MutateManagerResponse `xml:"mutateManagerResponse,omitempty" json:"mutateManagerResponse,omitempty" yaml:"mutateManagerResponse,omitempty"`
}

// managedCustomerServiceInterface implements the ManagedCustomerServiceInterface interface.
...
// customers identified by the selector.         @throws ApiException
// When there is at least one error with the request.
func (p *managedCustomerServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// or the client customer ids (invitees)         @throws ApiException
// when there is at least one error with the request
func (p *managedCustomerServiceInterface) GetPendingInvitations(GetPendingInvitations *GetPendingInvitations) (*GetPendingInvitationsResponse, error) {
	α := struct {
		OperationGetPendingInvitationsRequest `xml:"tns:getPendingInvitations"`
	}{
		OperationGetPendingInvitationsRequest{
			GetPendingInvitations,
		},
	}

	γ := struct {
		OperationGetPendingInvitationsResponse `xml:"getPendingInvitationsResponse"`
	}{}
	if err := p.cli.RoundTripWithAction("GetPendingInvitations", α, &γ); err != nil {
		return nil, err
	}
	return γ.GetPendingInvitationsResponse, nil
}
...
// managed customers, returned in the same order as the
//  <code>operations</code> array.
func (p *managedCustomerServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// method does not support partial failures, and will fail if any
//         operation is invalid.</p>
func (p *managedCustomerServiceInterface) MutateLabel(MutateLabel *MutateLabel) (*MutateLabelResponse, error) {
	α := struct {
...
// of operations         @return results for the given operations
//         @throws ApiException with a {@link ManagedCustomerServiceError}
func (p *managedCustomerServiceInterface) MutateLink(MutateLink *MutateLink) (*MutateLinkResponse, error) {
	α := struct {
		OperationMutateLinkRequest `xml:"tns:mutateLink"`
	}{
		OperationMutateLinkRequest{
			MutateLink,
		},
	}

	γ := struct {
		OperationMutateLinkResponse `xml:"mutateLinkResponse"`
	}{}
	if err := p.cli.RoundTripWithAction("MutateLink", α, &γ); err != nil {
		return nil, err
	}
	return γ.MutateLinkResponse, nil
}
...
// operations.         @return results for the given operations
//         @throws ApiException with a {@link ManagedCustomerServiceError}
func (p *managedCustomerServiceInterface) MutateManager(MutateManager *MutateManager) (*MutateManagerResponse, error) {
	α := struct {
		OperationMutateManagerRequest `xml:"tns:mutateManager"`
	}{
		OperationMutateManagerRequest{
			MutateManager,
		},
	}

	γ := struct {
		OperationMutateManagerResponse `xml:"mutateManagerResponse"`
	}{}
	if err := p.cli.RoundTripWithAction("MutateManager", α, &γ); err != nil {
		return nil, err
	}
	return γ.MutateManagerResponse, nil
}
