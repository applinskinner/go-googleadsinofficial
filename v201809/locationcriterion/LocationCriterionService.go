...
// NewLocationCriterionServiceInterface creates an initializes a LocationCriterionServiceInterface.
func NewLocationCriterionServiceInterface(cli *soap.Client) LocationCriterionServiceInterface {
	return &locationCriterionServiceInterface{cli}
}

// LocationCriterionServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type LocationCriterionServiceInterface interface {
	// Returns a list of {@link LocationCriterion}'s that match the
	// specified selector.                  @param selector filters
	// the LocationCriterion to be returned.         @return A list
	// of location criterion.         @throws ApiException when there
	...
	// string         @returns The list of location criteria
	//   @throws ApiException when the query is invalid or there are
...
// LocationCriterionServiceErrorReason was auto-generated from
// WSDL.
type LocationCriterionServiceErrorReason string

// Validate validates LocationCriterionServiceErrorReason.
func (v LocationCriterionServiceErrorReason) Validate() bool {
	for _, vv := range []string{
...
type LocationCriterion struct {
	...
	CanonicalName *string   `xml:"canonicalName,omitempty" json:"canonicalName,omitempty" yaml:"canonicalName,omitempty"`
	Reach         *int64    `xml:"reach,omitempty" json:"reach,omitempty" yaml:"reach,omitempty"`
...
type LocationCriterionServiceError struct {
	...
	ErrorString       *string                              `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string                              `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *LocationCriterionServiceErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string                               `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string                               `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *LocationCriterionServiceError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:LocationCriterionServiceError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval []*LocationCriterion `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// locationCriterionServiceInterface implements the LocationCriterionServiceInterface interface.
...
// of location criterion.         @throws ApiException when there
// is at least one error with the request.
func (p *locationCriterionServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
//   @throws ApiException when the query is invalid or there are
// errors processing the request.
func (p *locationCriterionServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
