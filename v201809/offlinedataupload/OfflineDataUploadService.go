...
// NewOfflineDataUploadServiceInterface creates an initializes a OfflineDataUploadServiceInterface.
func NewOfflineDataUploadServiceInterface(cli *soap.Client) OfflineDataUploadServiceInterface {
	return &offlineDataUploadServiceInterface{cli}
}

// OfflineDataUploadServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type OfflineDataUploadServiceInterface interface {
	// Returns a list of OfflineDataUpload objects that match the criteria
	// specified in the selector.                  <p><b>Note:</b>
	// If an upload fails after processing, reason will be reported
	// in {@link         OfflineDataUpload#failureReason}.
	//          @throws {@link ApiException} if problems occurred while
	// retrieving results.
	Get(Get *Get) (*GetResponse, error)

	// Applies a list of mutate operations (i.e. add, set) to offline
	// data upload:                  <p>Add - uploads offline data
	// for each entry in operations. Some operations can fail for upload
	//         level errors like invalid {@code UploadMetadata}. Check
	// {@code OfflineDataUploadReturnValue}         for partial failure
	// list.                  <p>Set - updates the upload result for
	// each upload. It is for internal use only.                  <p><b>Note:</b>
	// For AdWords API, one ADD request can have at most 2000 operations.
	//                  <p><b>Note:</b> Add operation might possibly
	// succeed even with errors in {@code OfflineData}.         Data
	// errors are reported in {@link OfflineDataUpload#partialDataErrors}
	//                  <p><b>Note:</b> Supports only the {@code ADD}
	// operator. {@code SET} operator is internally used         only.({@code
	// REMOVE} is not supported).                  @param operations
	// A list of offline data upload operations.         @return The
	// list of offline data upload results in the same order as operations.
...
// OfflineDataUploadErrorReason was auto-generated from WSDL.
type OfflineDataUploadErrorReason string

// Validate validates OfflineDataUploadErrorReason.
func (v OfflineDataUploadErrorReason) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
...
// OfflineDataUploadFailureReason was auto-generated from WSDL.
type OfflineDataUploadFailureReason string

// Validate validates OfflineDataUploadFailureReason.
func (v OfflineDataUploadFailureReason) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
...
// OfflineDataUploadStatus was auto-generated from WSDL.
type OfflineDataUploadStatus string

// Validate validates OfflineDataUploadStatus.
func (v OfflineDataUploadStatus) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
		"FAILURE",
		"IN_PROCESS",
...
// OfflineDataUploadType was auto-generated from WSDL.
type OfflineDataUploadType string

// Validate validates OfflineDataUploadType.
func (v OfflineDataUploadType) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
...
// OfflineDataUploadUserIdentifierType was auto-generated from
// WSDL.
type OfflineDataUploadUserIdentifierType string

// Validate validates OfflineDataUploadUserIdentifierType.
func (v OfflineDataUploadUserIdentifierType) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
		"HASHED_EMAIL",
		"HASHED_PHONE",
...
type FirstPartyUploadMetadata struct {
	LoyaltyRate                        *float64 `xml:"loyaltyRate,omitempty" json:"loyaltyRate,omitempty" yaml:"loyaltyRate,omitempty"`
	TransactionUploadRate              *float64 `xml:"transactionUploadRate,omitempty" json:"transactionUploadRate,omitempty" yaml:"transactionUploadRate,omitempty"`
	StoreSalesUploadCommonMetadataType *string  `xml:"StoreSalesUploadCommonMetadata.Type,omitempty" json:"StoreSalesUploadCommonMetadata.Type,omitempty" yaml:"StoreSalesUploadCommonMetadata.Type,omitempty"`
	TypeAttrXSI                        string   `xml:"xsi:type,attr,omitempty"`
	TypeNamespace                      string   `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *FirstPartyUploadMetadata) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:FirstPartyUploadMetadata"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type OfflineData struct {
	StoreSalesTransaction *StoreSalesTransaction `xml:"StoreSalesTransaction" json:"StoreSalesTransaction" yaml:"StoreSalesTransaction"`
}

// Data representing offline transactions.
type OfflineDataUpload struct {
	ExternalUploadId *int64                          `xml:"externalUploadId,omitempty" json:"externalUploadId,omitempty" yaml:"externalUploadId,omitempty"`
	UploadType       *OfflineDataUploadType          `xml:"uploadType,omitempty" json:"uploadType,omitempty" yaml:"uploadType,omitempty"`
	UploadStatus     *OfflineDataUploadStatus        `xml:"uploadStatus,omitempty" json:"uploadStatus,omitempty" yaml:"uploadStatus,omitempty"`
	UploadMetadata   *UploadMetadata                 `xml:"uploadMetadata,omitempty" json:"uploadMetadata,omitempty" yaml:"uploadMetadata,omitempty"`
	OfflineDataList  []*OfflineData                  `xml:"offlineDataList,omitempty" json:"offlineDataList,omitempty" yaml:"offlineDataList,omitempty"`
	FailureReason    *OfflineDataUploadFailureReason `xml:"failureReason,omitempty" json:"failureReason,omitempty" yaml:"failureReason,omitempty"`
}
...
type OfflineDataUploadError struct {
	...
	ErrorString       *string                       `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string                       `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *OfflineDataUploadErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string                        `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string                        `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *OfflineDataUploadError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:OfflineDataUploadError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type OfflineDataUploadOperation struct {
	...
	Operand       *OfflineDataUpload `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string             `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string             `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *OfflineDataUploadOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:OfflineDataUploadOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// Contains a list of OfflineDataUpload resulting from filtering
// and paging of get call.
type OfflineDataUploadPage struct {
	...
	Entries         []*OfflineDataUpload `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string               `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string               `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *OfflineDataUploadPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:OfflineDataUploadPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type OfflineDataUploadReturnValue struct {
	...
	Value                []*OfflineDataUpload `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *OfflineDataUploadReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:OfflineDataUploadReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type StoreSalesTransaction struct {
	UserIdentifiers   []*UserIdentifier  `xml:"userIdentifiers,omitempty" json:"userIdentifiers,omitempty" yaml:"userIdentifiers,omitempty"`
	TransactionTime   *string            `xml:"transactionTime,omitempty" json:"transactionTime,omitempty" yaml:"transactionTime,omitempty"`
	TransactionAmount *MoneyWithCurrency `xml:"transactionAmount,omitempty" json:"transactionAmount,omitempty" yaml:"transactionAmount,omitempty"`
...
type StoreSalesUploadCommonMetadata interface{}
...
// Metadata for a Third party Store Sales upload.             Note:
// This is a whitelisted only product. Please contact your Google
...
type ThirdPartyUploadMetadata struct {
	...
	TransactionUploadRate              *float64 `xml:"transactionUploadRate,omitempty" json:"transactionUploadRate,omitempty" yaml:"transactionUploadRate,omitempty"`
	StoreSalesUploadCommonMetadataType *string  `xml:"StoreSalesUploadCommonMetadata.Type,omitempty" json:"StoreSalesUploadCommonMetadata.Type,omitempty" yaml:"StoreSalesUploadCommonMetadata.Type,omitempty"`
	AdvertiserUploadTime               *string  `xml:"advertiserUploadTime,omitempty" json:"advertiserUploadTime,omitempty" yaml:"advertiserUploadTime,omitempty"`
	ValidTransactionRate               *float64 `xml:"validTransactionRate,omitempty" json:"validTransactionRate,omitempty" yaml:"validTransactionRate,omitempty"`
	PartnerMatchRate                   *float64 `xml:"partnerMatchRate,omitempty" json:"partnerMatchRate,omitempty" yaml:"partnerMatchRate,omitempty"`
	PartnerUploadRate                  *float64 `xml:"partnerUploadRate,omitempty" json:"partnerUploadRate,omitempty" yaml:"partnerUploadRate,omitempty"`
	BridgeMapVersionId                 *string  `xml:"bridgeMapVersionId,omitempty" json:"bridgeMapVersionId,omitempty" yaml:"bridgeMapVersionId,omitempty"`
	PartnerId                          *int     `xml:"partnerId,omitempty" json:"partnerId,omitempty" yaml:"partnerId,omitempty"`
	TypeAttrXSI                        string   `xml:"xsi:type,attr,omitempty"`
	TypeNamespace                      string   `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *ThirdPartyUploadMetadata) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:ThirdPartyUploadMetadata"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type UploadMetadata struct {
	StoreSalesUploadCommonMetadata *StoreSalesUploadCommonMetadata `xml:"StoreSalesUploadCommonMetadata" json:"StoreSalesUploadCommonMetadata" yaml:"StoreSalesUploadCommonMetadata"`
}

// Hashed user identifying information.
type UserIdentifier struct {
	UserIdentifierType *OfflineDataUploadUserIdentifierType `xml:"userIdentifierType,omitempty" json:"userIdentifierType,omitempty" yaml:"userIdentifierType,omitempty"`
...
type GetResponse struct {
	Rval *OfflineDataUploadPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*OfflineDataUploadOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *OfflineDataUploadReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// offlineDataUploadServiceInterface implements the OfflineDataUploadServiceInterface interface.
...
//          @throws {@link ApiException} if problems occurred while
// retrieving results.
func (p *offlineDataUploadServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// list of offline data upload results in the same order as operations.
//         @throws {@link ApiException} if problems occur.
func (p *offlineDataUploadServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
