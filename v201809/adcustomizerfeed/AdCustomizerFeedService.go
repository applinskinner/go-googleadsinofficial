...
// NewAdCustomizerFeedServiceInterface creates an initializes a AdCustomizerFeedServiceInterface.
func NewAdCustomizerFeedServiceInterface(cli *soap.Client) AdCustomizerFeedServiceInterface {
	return &adCustomizerFeedServiceInterface{cli}
}

// AdCustomizerFeedServiceInterface was auto-generated from WSDL
...
type AdCustomizerFeedServiceInterface interface {
	...
	//                  @param selector Determines which AdCustomizerFeeds
	// to return. If empty, all AdCustomizerFeeds         are returned.
	//         @return The list of AdCustomizerFeeds.         @throws
	...
	// The resulting AdCustomizerFeeds.         @throws ApiException
...
// AdCustomizerFeedAttributeType was auto-generated from WSDL.
type AdCustomizerFeedAttributeType string

// Validate validates AdCustomizerFeedAttributeType.
func (v AdCustomizerFeedAttributeType) Validate() bool {
...
// AdCustomizerFeedErrorReason was auto-generated from WSDL.
type AdCustomizerFeedErrorReason string

// Validate validates AdCustomizerFeedErrorReason.
func (v AdCustomizerFeedErrorReason) Validate() bool {
	for _, vv := range []string{
...
//                          <p>An AdCustomizerFeed is a view of
// a regular Feed, but with some simplifications intended to
...
type AdCustomizerFeed struct {
	...
	FeedStatus     *FeedStatus                  `xml:"feedStatus,omitempty" json:"feedStatus,omitempty" yaml:"feedStatus,omitempty"`
	FeedAttributes []*AdCustomizerFeedAttribute `xml:"feedAttributes,omitempty" json:"feedAttributes,omitempty" yaml:"feedAttributes,omitempty"`
}
...
type AdCustomizerFeedAttribute struct {
	...
	Type *AdCustomizerFeedAttributeType `xml:"type,omitempty" json:"type,omitempty" yaml:"type,omitempty"`
}
...
type AdCustomizerFeedError struct {
	...
	Reason            *AdCustomizerFeedErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
...
func (t *AdCustomizerFeedError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:AdCustomizerFeedError"
	}
...
type AdCustomizerFeedOperation struct {
	...
	Operand       *AdCustomizerFeed `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string            `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string            `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *AdCustomizerFeedOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:AdCustomizerFeedOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type AdCustomizerFeedPage struct {
	...
	Entries         []*AdCustomizerFeed `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string              `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string              `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *AdCustomizerFeedPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:AdCustomizerFeedPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type AdCustomizerFeedReturnValue struct {
	...
	Value               []*AdCustomizerFeed `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
	TypeAttrXSI         string              `xml:"xsi:type,attr,omitempty"`
	TypeNamespace       string              `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *AdCustomizerFeedReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:AdCustomizerFeedReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *AdCustomizerFeedPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*AdCustomizerFeedOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *AdCustomizerFeedReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// adCustomizerFeedServiceInterface implements the AdCustomizerFeedServiceInterface interface.
...
//         @return The list of AdCustomizerFeeds.         @throws
// ApiException Indicates a problem with the request.
func (p *adCustomizerFeedServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// The resulting AdCustomizerFeeds.         @throws ApiException
// Indicates a problem with the request.
func (p *adCustomizerFeedServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
