...
// NewCampaignFeedServiceInterface creates an initializes a CampaignFeedServiceInterface.
func NewCampaignFeedServiceInterface(cli *soap.Client) CampaignFeedServiceInterface {
	return &campaignFeedServiceInterface{cli}
}

// CampaignFeedServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type CampaignFeedServiceInterface interface {
	// Returns a list of CampaignFeeds that meet the selector criteria.
	//                  @param selector Determines which CampaignFeeds
	// to return. If empty all         Campaign feeds are returned.
	//         @return The list of CampaignFeeds.         @throws ApiException
	// Indicates a problem with the request.
	Get(Get *Get) (*GetResponse, error)

	// Adds, sets or removes CampaignFeeds.                  @param
	// operations The operations to apply.         @return The resulting
	// Feeds.         @throws ApiException Indicates a problem with
	// the request.
	Mutate(Mutate *Mutate) (*MutateResponse, error)

	// Returns a list of {@link CampaignFeed}s inside a {@link CampaignFeedPage}
	// that matches         the query.                  @param query
	// The SQL-like AWQL query string.         @throws ApiException
...
// CampaignFeedStatus was auto-generated from WSDL.
type CampaignFeedStatus string

// Validate validates CampaignFeedStatus.
func (v CampaignFeedStatus) Validate() bool {
	for _, vv := range []string{
		"ENABLED",
		"REMOVED",
		"UNKNOWN",
...
// RequestContextOperandContextType was auto-generated from WSDL.
type RequestContextOperandContextType string

// Validate validates RequestContextOperandContextType.
func (v RequestContextOperandContextType) Validate() bool {
	for _, vv := range []string{
		"FEED_ITEM_ID",
		"DEVICE_PLATFORM",
		"UNKNOWN",
...
// CampaignFeeds are used to link a feed to a campaign using a
// matching function,             making the feed's feed items
// available in the campaign's ads for substitution.
type CampaignFeed struct {
	...
	PlaceholderTypes []*int              `xml:"placeholderTypes,omitempty" json:"placeholderTypes,omitempty" yaml:"placeholderTypes,omitempty"`
	Status           *CampaignFeedStatus `xml:"status,omitempty" json:"status,omitempty" yaml:"status,omitempty"`
...
type CampaignFeedOperation struct {
	...
	Operand       *CampaignFeed `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string        `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string        `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignFeedOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignFeedOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// a list of             associations between campaign and feeds.
type CampaignFeedPage struct {
	...
	Entries         []*CampaignFeed `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string          `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string          `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignFeedPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignFeedPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type CampaignFeedReturnValue struct {
	...
	Value                []*CampaignFeed `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignFeedReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignFeedReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type FeedAttributeOperand struct {
	FunctionArgumentOperandType *string `xml:"FunctionArgumentOperand.Type,omitempty" json:"FunctionArgumentOperand.Type,omitempty" yaml:"FunctionArgumentOperand.Type,omitempty"`
	FeedId                      *int64  `xml:"feedId,omitempty" json:"feedId,omitempty" yaml:"feedId,omitempty"`
	FeedAttributeId             *int64  `xml:"feedAttributeId,omitempty" json:"feedAttributeId,omitempty" yaml:"feedAttributeId,omitempty"`
	TypeAttrXSI                 string  `xml:"xsi:type,attr,omitempty"`
	TypeNamespace               string  `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *FeedAttributeOperand) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:FeedAttributeOperand"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// A function operand in a matching function.             Used
// to represent nested functions.
type FunctionOperand struct {
	FunctionArgumentOperandType *string   `xml:"FunctionArgumentOperand.Type,omitempty" json:"FunctionArgumentOperand.Type,omitempty" yaml:"FunctionArgumentOperand.Type,omitempty"`
	Value                       *Function `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
	TypeAttrXSI                 string    `xml:"xsi:type,attr,omitempty"`
	TypeNamespace               string    `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *FunctionOperand) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:FunctionOperand"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type RequestContextOperand struct {
	FunctionArgumentOperandType *string                           `xml:"FunctionArgumentOperand.Type,omitempty" json:"FunctionArgumentOperand.Type,omitempty" yaml:"FunctionArgumentOperand.Type,omitempty"`
	ContextType                 *RequestContextOperandContextType `xml:"contextType,omitempty" json:"contextType,omitempty" yaml:"contextType,omitempty"`
	TypeAttrXSI                 string                            `xml:"xsi:type,attr,omitempty"`
	TypeNamespace               string                            `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *RequestContextOperand) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:RequestContextOperand"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *CampaignFeedPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*CampaignFeedOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *CampaignFeedReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// campaignFeedServiceInterface implements the CampaignFeedServiceInterface interface.
...
//         @return The list of CampaignFeeds.         @throws ApiException
// Indicates a problem with the request.
func (p *campaignFeedServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// Feeds.         @throws ApiException Indicates a problem with
// the request.
func (p *campaignFeedServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// The SQL-like AWQL query string.         @throws ApiException
// when there are one or more errors with the request.
func (p *campaignFeedServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
