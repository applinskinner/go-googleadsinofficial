...
// NewLabelServiceInterface creates an initializes a LabelServiceInterface.
func NewLabelServiceInterface(cli *soap.Client) LabelServiceInterface {
	return &labelServiceInterface{cli}
}

// LabelServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type LabelServiceInterface interface {
	// Returns a list of {@link Label}s.                  @param serviceSelector
	// The selector specifying the {@link Label}s to return.
	//   @return The page containing the {@link Label}s which meet
	// the criteria specified by the         selector.         @throws
	...
	// operations The operations to apply. The same {@link Label} cannot
	// be specified in         more than one operation.         @return
	// The applied {@link Label}s.         @throws ApiException when
	...
	//       @returns  The page containing the {@link Label}s which
	// match the query.         @throws ApiException when the query
...
// LabelErrorReason was auto-generated from WSDL.
type LabelErrorReason string

// Validate validates LabelErrorReason.
func (v LabelErrorReason) Validate() bool {
	for _, vv := range []string{
		"DUPLICATE_NAME",
		"INVALID_LABEL_NAME",
		"INVALID_LABEL_TYPE",
...
type LabelError struct {
	...
	ErrorString       *string             `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string             `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *LabelErrorReason   `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string              `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string              `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *LabelError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:LabelError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type LabelOperation struct {
	...
	Operand       *Label    `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string    `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string    `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *LabelOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:LabelOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// Contains a subset of labels resulting from the filtering and
// paging of the             {@link LabelService#get} call.
type LabelPage struct {
	...
	Entries         []*Label `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string   `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string   `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *LabelPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:LabelPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type LabelReturnValue struct {
	...
	Value               []*Label `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
	TypeAttrXSI         string   `xml:"xsi:type,attr,omitempty"`
	TypeNamespace       string   `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *LabelReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:LabelReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *LabelPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*LabelOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *LabelReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// labelServiceInterface implements the LabelServiceInterface interface.
...
// the criteria specified by the         selector.         @throws
// ApiException when there is at least one error with the request
func (p *labelServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// The applied {@link Label}s.         @throws ApiException when
// there is at least one error with the request
func (p *labelServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// match the query.         @throws ApiException when the query
// is invalid or there are errors processing the request.
func (p *labelServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
