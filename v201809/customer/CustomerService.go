...
// NewCustomerServiceInterface creates an initializes a CustomerServiceInterface.
func NewCustomerServiceInterface(cli *soap.Client) CustomerServiceInterface {
	return &customerServiceInterface{cli}
}

// CustomerServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type CustomerServiceInterface interface {
	// Returns details of all the customers directly accessible by
	// the user authenticating the call.         <p>         Note:
	// This method will return only test accounts if the developer
	// token used has not been         approved.         <p>
	//   Starting with v201607, if {@code clientCustomerId} is specified
	// in the request header,         only details of that customer
	// will be returned. To do this for prior versions, use the
	//      {@code get()} method instead.
	GetCustomers(GetCustomers *GetCustomers) (*GetCustomersResponse, error)

	// Retrieves the list of service links for the authorized customer.
	//         See {@link ServiceType} for information on the various
	// linking types supported.                  @param selector describing
	// which links to retrieve         @throws ApiException
	GetServiceLinks(GetServiceLinks *GetServiceLinks) (*GetServiceLinksResponse, error)

	// Update the authorized customer.                  <p>While there
	// are a limited set of properties available to update, please
	// read this         <a href="https://support.google.com/analytics/answer/1033981">help
	// center article         on auto-tagging</a> before updating {@code
	// customer.autoTaggingEnabled}.                  @param customer
	// the requested updated value for the customer.         @throws
	// ApiException
	Mutate(Mutate *Mutate) (*MutateResponse, error)

	// Modifies links to other services for the authorized customer.
	//         See {@link ServiceType} for information on the various
	// linking types supported.                  @param operations
	// to perform         @throws ApiException
	MutateServiceLinks(MutateServiceLinks *MutateServiceLinks) (*MutateServiceLinksResponse, error)
}
...
// CustomerErrorReason was auto-generated from WSDL.
type CustomerErrorReason string

// Validate validates CustomerErrorReason.
func (v CustomerErrorReason) Validate() bool {
	for _, vv := range []string{
...
// ServiceLinkLinkStatus was auto-generated from WSDL.
type ServiceLinkLinkStatus string

// Validate validates ServiceLinkLinkStatus.
func (v ServiceLinkLinkStatus) Validate() bool {
	for _, vv := range []string{
		"ACTIVE",
		"PENDING",
		"UNKNOWN",
...
// ServiceType was auto-generated from WSDL.
type ServiceType string

// Validate validates ServiceType.
func (v ServiceType) Validate() bool {
	for _, vv := range []string{
		"MERCHANT_CENTER",
		"UNKNOWN",
	} {
...
// Tracking. Settings             that apply at the conversion
// type level can be accessed and modified though             {@code
// ConversionTrackerService}.
type ConversionTrackingSettings struct {
	EffectiveConversionTrackingId      *int64 `xml:"effectiveConversionTrackingId,omitempty" json:"effectiveConversionTrackingId,omitempty" yaml:"effectiveConversionTrackingId,omitempty"`
	UsesCrossAccountConversionTracking *bool  `xml:"usesCrossAccountConversionTracking,omitempty" json:"usesCrossAccountConversionTracking,omitempty" yaml:"usesCrossAccountConversionTracking,omitempty"`
}
...
type Customer struct {
	...
	DescriptiveName            *string                     `xml:"descriptiveName,omitempty" json:"descriptiveName,omitempty" yaml:"descriptiveName,omitempty"`
	...
	AutoTaggingEnabled         *bool                       `xml:"autoTaggingEnabled,omitempty" json:"autoTaggingEnabled,omitempty" yaml:"autoTaggingEnabled,omitempty"`
	...
	ParallelTrackingEnabled    *bool                       `xml:"parallelTrackingEnabled,omitempty" json:"parallelTrackingEnabled,omitempty" yaml:"parallelTrackingEnabled,omitempty"`
	ConversionTrackingSettings *ConversionTrackingSettings `xml:"conversionTrackingSettings,omitempty" json:"conversionTrackingSettings,omitempty" yaml:"conversionTrackingSettings,omitempty"`
	RemarketingSettings        *RemarketingSettings        `xml:"remarketingSettings,omitempty" json:"remarketingSettings,omitempty" yaml:"remarketingSettings,omitempty"`
}
...
type CustomerError struct {
	...
	ErrorString       *string              `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string              `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *CustomerErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string               `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string               `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CustomerError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CustomerError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type ServiceLink struct {
	ServiceType   *ServiceType           `xml:"serviceType,omitempty" json:"serviceType,omitempty" yaml:"serviceType,omitempty"`
	ServiceLinkId *int64                 `xml:"serviceLinkId,omitempty" json:"serviceLinkId,omitempty" yaml:"serviceLinkId,omitempty"`
	LinkStatus    *ServiceLinkLinkStatus `xml:"linkStatus,omitempty" json:"linkStatus,omitempty" yaml:"linkStatus,omitempty"`
	Name          *string                `xml:"name,omitempty" json:"name,omitempty" yaml:"name,omitempty"`
}

// An operation on an AdWords link.             See {@link ServiceType}
// for information on the various linking types supported.
type ServiceLinkOperation struct {
	...
	Operand       *ServiceLink `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string       `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string       `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *ServiceLinkOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:ServiceLinkOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// GetCustomers was auto-generated from WSDL.
type GetCustomers struct {
}

// GetCustomersResponse was auto-generated from WSDL.
type GetCustomersResponse struct {
	Rval []*Customer `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// GetServiceLinks was auto-generated from WSDL.
type GetServiceLinks struct {
	Selector *Selector `xml:"selector,omitempty" json:"selector,omitempty" yaml:"selector,omitempty"`
}

// GetServiceLinksResponse was auto-generated from WSDL.
type GetServiceLinksResponse struct {
	Rval []*ServiceLink `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Customer *Customer `xml:"customer,omitempty" json:"customer,omitempty" yaml:"customer,omitempty"`
}
...
// MutateServiceLinks was auto-generated from WSDL.
type MutateServiceLinks struct {
	Operations []*ServiceLinkOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateServiceLinksResponse was auto-generated from WSDL.
type MutateServiceLinksResponse struct {
	Rval []*ServiceLink `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Operation wrapper for GetCustomers.
// OperationGetCustomersRequest was auto-generated from WSDL.
type OperationGetCustomersRequest struct {
	GetCustomers *GetCustomers `xml:"getCustomers,omitempty" json:"getCustomers,omitempty" yaml:"getCustomers,omitempty"`
}

// Operation wrapper for GetCustomers.
// OperationGetCustomersResponse was auto-generated from WSDL.
type OperationGetCustomersResponse struct {
	GetCustomersResponse *GetCustomersResponse `xml:"getCustomersResponse,omitempty" json:"getCustomersResponse,omitempty" yaml:"getCustomersResponse,omitempty"`
}

// Operation wrapper for GetServiceLinks.
// OperationGetServiceLinksRequest was auto-generated from WSDL.
type OperationGetServiceLinksRequest struct {
	GetServiceLinks *GetServiceLinks `xml:"getServiceLinks,omitempty" json:"getServiceLinks,omitempty" yaml:"getServiceLinks,omitempty"`
}

// Operation wrapper for GetServiceLinks.
// OperationGetServiceLinksResponse was auto-generated from WSDL.
type OperationGetServiceLinksResponse struct {
	GetServiceLinksResponse *GetServiceLinksResponse `xml:"getServiceLinksResponse,omitempty" json:"getServiceLinksResponse,omitempty" yaml:"getServiceLinksResponse,omitempty"`
}
...
// Operation wrapper for MutateServiceLinks.
// OperationMutateServiceLinksRequest was auto-generated from WSDL.
type OperationMutateServiceLinksRequest struct {
	MutateServiceLinks *MutateServiceLinks `xml:"mutateServiceLinks,omitempty" json:"mutateServiceLinks,omitempty" yaml:"mutateServiceLinks,omitempty"`
}

// Operation wrapper for MutateServiceLinks.
// OperationMutateServiceLinksResponse was auto-generated from
// WSDL.
type OperationMutateServiceLinksResponse struct {
	MutateServiceLinksResponse *MutateServiceLinksResponse `xml:"mutateServiceLinksResponse,omitempty" json:"mutateServiceLinksResponse,omitempty" yaml:"mutateServiceLinksResponse,omitempty"`
}

// customerServiceInterface implements the CustomerServiceInterface interface.
...
// will be returned. To do this for prior versions, use the
//      {@code get()} method instead.
func (p *customerServiceInterface) GetCustomers(GetCustomers *GetCustomers) (*GetCustomersResponse, error) {
	α := struct {
		OperationGetCustomersRequest `xml:"tns:getCustomers"`
	}{
		OperationGetCustomersRequest{
			GetCustomers,
		},
	}

	γ := struct {
		OperationGetCustomersResponse `xml:"getCustomersResponse"`
	}{}
	if err := p.cli.RoundTripWithAction("GetCustomers", α, &γ); err != nil {
		return nil, err
	}
	return γ.GetCustomersResponse, nil
}
...
// linking types supported.                  @param selector describing
// which links to retrieve         @throws ApiException
func (p *customerServiceInterface) GetServiceLinks(GetServiceLinks *GetServiceLinks) (*GetServiceLinksResponse, error) {
	α := struct {
		OperationGetServiceLinksRequest `xml:"tns:getServiceLinks"`
	}{
		OperationGetServiceLinksRequest{
			GetServiceLinks,
		},
	}

	γ := struct {
		OperationGetServiceLinksResponse `xml:"getServiceLinksResponse"`
	}{}
	if err := p.cli.RoundTripWithAction("GetServiceLinks", α, &γ); err != nil {
		return nil, err
	}
	return γ.GetServiceLinksResponse, nil
}
...
// the requested updated value for the customer.         @throws
// ApiException
func (p *customerServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// linking types supported.                  @param operations
// to perform         @throws ApiException
func (p *customerServiceInterface) MutateServiceLinks(MutateServiceLinks *MutateServiceLinks) (*MutateServiceLinksResponse, error) {
	α := struct {
		OperationMutateServiceLinksRequest `xml:"tns:mutateServiceLinks"`
	}{
		OperationMutateServiceLinksRequest{
			MutateServiceLinks,
		},
	}

	γ := struct {
		OperationMutateServiceLinksResponse `xml:"mutateServiceLinksResponse"`
	}{}
	if err := p.cli.RoundTripWithAction("MutateServiceLinks", α, &γ); err != nil {
		return nil, err
	}
	return γ.MutateServiceLinksResponse, nil
}
