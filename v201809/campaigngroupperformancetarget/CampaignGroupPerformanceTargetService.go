package campaigngroupperformancetarget
...
// NewCampaignGroupPerformanceTargetServiceInterface creates an initializes a CampaignGroupPerformanceTargetServiceInterface.
func NewCampaignGroupPerformanceTargetServiceInterface(cli *soap.Client) CampaignGroupPerformanceTargetServiceInterface {
	return &campaignGroupPerformanceTargetServiceInterface{cli}
}

// CampaignGroupPerformanceTargetServiceInterface was auto-generated from WSDL
...
type CampaignGroupPerformanceTargetServiceInterface interface {
	...
	// meet the selector criteria.                  @param selector
	// specifying the {@link CampaignGroupPerformanceTarget}s to return.
	...
	//         @return The list of updated campaign groups performance
	// targets, returned in the same order as         the <code>operations</code>
	// array.         @throws ApiException if problems occurred while
	// updating campaign group performance target         information.
...
// CampaignGroupPerformanceTargetErrorReason was auto-generated
// from WSDL.
type CampaignGroupPerformanceTargetErrorReason string

// Validate validates CampaignGroupPerformanceTargetErrorReason.
func (v CampaignGroupPerformanceTargetErrorReason) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
	} {
		if reflect.DeepEqual(v, vv) {
...
// EfficiencyTargetType was auto-generated from WSDL.
type EfficiencyTargetType string

// Validate validates EfficiencyTargetType.
func (v EfficiencyTargetType) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
		"NONE",
...
// PerformanceTargetErrorReason was auto-generated from WSDL.
type PerformanceTargetErrorReason string

// Validate validates PerformanceTargetErrorReason.
func (v PerformanceTargetErrorReason) Validate() bool {
	for _, vv := range []string{
...
// PerformanceTargetStatus was auto-generated from WSDL.
type PerformanceTargetStatus string

// Validate validates PerformanceTargetStatus.
func (v PerformanceTargetStatus) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
...
// SpendTargetType was auto-generated from WSDL.
type SpendTargetType string

// Validate validates SpendTargetType.
func (v SpendTargetType) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
		"NONE",
		"MINIMUM",
...
// VolumeGoalType was auto-generated from WSDL.
type VolumeGoalType string

// Validate validates VolumeGoalType.
func (v VolumeGoalType) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
...
// group performance target is an             entity that specifies
// a time range for a campaign group and various metrics by which
// the             performance of that campaign group can be measured
// for the time period that the performance             target
// is active.
type CampaignGroupPerformanceTarget struct {
	...
	PerformanceTarget *PerformanceTarget `xml:"performanceTarget,omitempty" json:"performanceTarget,omitempty" yaml:"performanceTarget,omitempty"`
}
...
type CampaignGroupPerformanceTargetError struct {
	...
	ErrorString       *string                                    `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string                                    `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *CampaignGroupPerformanceTargetErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string                                     `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string                                     `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignGroupPerformanceTargetError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignGroupPerformanceTargetError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type CampaignGroupPerformanceTargetOperation struct {
	...
	Operand       *CampaignGroupPerformanceTarget `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string                          `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string                          `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignGroupPerformanceTargetOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignGroupPerformanceTargetOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// from the filtering and paging             of the {CampaignGroupPerformanceTargetService#get}
// call.
type CampaignGroupPerformanceTargetPage struct {
	...
	Entries         []*CampaignGroupPerformanceTarget `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string                            `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string                            `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignGroupPerformanceTargetPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignGroupPerformanceTargetPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type CampaignGroupPerformanceTargetReturnValue struct {
	...
	Value                []*CampaignGroupPerformanceTarget `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignGroupPerformanceTargetReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignGroupPerformanceTargetReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type PerformanceTarget struct {
	VolumeGoalType         *VolumeGoalType          `xml:"volumeGoalType,omitempty" json:"volumeGoalType,omitempty" yaml:"volumeGoalType,omitempty"`
	VolumeTargetValue      *int64                   `xml:"volumeTargetValue,omitempty" json:"volumeTargetValue,omitempty" yaml:"volumeTargetValue,omitempty"`
	EfficiencyTargetType   *EfficiencyTargetType    `xml:"efficiencyTargetType,omitempty" json:"efficiencyTargetType,omitempty" yaml:"efficiencyTargetType,omitempty"`
	EfficiencyTargetValue  *float64                 `xml:"efficiencyTargetValue,omitempty" json:"efficiencyTargetValue,omitempty" yaml:"efficiencyTargetValue,omitempty"`
	SpendTarget            *Money                   `xml:"spendTarget,omitempty" json:"spendTarget,omitempty" yaml:"spendTarget,omitempty"`
	SpendTargetType        *SpendTargetType         `xml:"spendTargetType,omitempty" json:"spendTargetType,omitempty" yaml:"spendTargetType,omitempty"`
	ForecastStatus         *PerformanceTargetStatus `xml:"forecastStatus,omitempty" json:"forecastStatus,omitempty" yaml:"forecastStatus,omitempty"`
	HasPromotedSuggestions *bool                    `xml:"hasPromotedSuggestions,omitempty" json:"hasPromotedSuggestions,omitempty" yaml:"hasPromotedSuggestions,omitempty"`
...
type PerformanceTargetError struct {
	...
	ErrorString       *string                       `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string                       `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *PerformanceTargetErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string                        `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string                        `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *PerformanceTargetError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:PerformanceTargetError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *CampaignGroupPerformanceTargetPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*CampaignGroupPerformanceTargetOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *CampaignGroupPerformanceTargetReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// campaignGroupPerformanceTargetServiceInterface implements the CampaignGroupPerformanceTargetServiceInterface interface.
...
//         @throws ApiException if problems occurred while fetching
// campaign group performance target         information.
func (p *campaignGroupPerformanceTargetServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// array.         @throws ApiException if problems occurred while
// updating campaign group performance target         information.
func (p *campaignGroupPerformanceTargetServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
