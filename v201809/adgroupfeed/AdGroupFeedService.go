...
// NewAdGroupFeedServiceInterface creates an initializes a AdGroupFeedServiceInterface.
func NewAdGroupFeedServiceInterface(cli *soap.Client) AdGroupFeedServiceInterface {
	return &adGroupFeedServiceInterface{cli}
}

// AdGroupFeedServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type AdGroupFeedServiceInterface interface {
	// Returns a list of AdGroupFeeds that meet the selector criteria.
	//                  @param selector Determines which AdGroupFeeds
	// to return. If empty all         adgroup feeds are returned.
	//         @return The list of AdgroupFeeds.         @throws ApiException
	// Indicates a problem with the request.
	Get(Get *Get) (*GetResponse, error)

	// Adds, updates or removes AdGroupFeeds.                  @param
	...
	//      @returns A list of AdGroupFeed.         @throws ApiException
	// if problems occur while parsing the query or fetching AdGroupFeed.
	Query(Query string) (*QueryResponse, error)
}

// AdGroupFeedStatus was auto-generated from WSDL.
type AdGroupFeedStatus string

// Validate validates AdGroupFeedStatus.
func (v AdGroupFeedStatus) Validate() bool {
...
// function,             making the feed's feed items available
// in the adgroup's ads for substitution.
type AdGroupFeed struct {
	...
	Status           *AdGroupFeedStatus `xml:"status,omitempty" json:"status,omitempty" yaml:"status,omitempty"`
...
type AdGroupFeedOperation struct {
	...
	Operand       *AdGroupFeed `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string       `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string       `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *AdGroupFeedOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:AdGroupFeedOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// of             associations between ad groups and feeds.
type AdGroupFeedPage struct {
	...
	Entries         []*AdGroupFeed `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string         `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string         `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *AdGroupFeedPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:AdGroupFeedPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type AdGroupFeedReturnValue struct {
	...
	Value                []*AdGroupFeed `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *AdGroupFeedReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:AdGroupFeedReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *AdGroupFeedPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*AdGroupFeedOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *AdGroupFeedReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// adGroupFeedServiceInterface implements the AdGroupFeedServiceInterface interface.
...
//         @return The list of AdgroupFeeds.         @throws ApiException
// Indicates a problem with the request.
func (p *adGroupFeedServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// Feeds.         @throws ApiException Indicates a problem with
// the request.
func (p *adGroupFeedServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
//      @returns A list of AdGroupFeed.         @throws ApiException
// if problems occur while parsing the query or fetching AdGroupFeed.
func (p *adGroupFeedServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
