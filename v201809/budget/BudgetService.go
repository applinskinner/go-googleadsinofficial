...
// NewBudgetServiceInterface creates an initializes a BudgetServiceInterface.
func NewBudgetServiceInterface(cli *soap.Client) BudgetServiceInterface {
	return &budgetServiceInterface{cli}
}

// BudgetServiceInterface was auto-generated from WSDL
...
type BudgetServiceInterface interface {
	...
	// list of Budgets, returned in the same order as <code>operations</code>.
	//         @throws ApiException
	...
	// A list of Budget         @throws ApiException when the query
...
type BudgetOperation struct {
	...
	Operand       *Budget   `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string    `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string    `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *BudgetOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:BudgetOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// Contains a list of budgets resulting from the filtering and
// paging of             {@link BudgetService#get} call.
type BudgetPage struct {
	...
	Entries         []*Budget `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string    `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string    `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *BudgetPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:BudgetPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type BudgetReturnValue struct {
	...
	Value                []*Budget   `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *BudgetReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:BudgetReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *BudgetPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*BudgetOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *BudgetReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// budgetServiceInterface implements the BudgetServiceInterface interface.
...
//        @throws com.google.ads.api.services.common.error.ApiException
// if problems         occurred while retrieving results.
func (p *budgetServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// list of Budgets, returned in the same order as <code>operations</code>.
//         @throws ApiException
func (p *budgetServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// A list of Budget         @throws ApiException when the query
// is invalid or there are errors processing the request.
func (p *budgetServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
