...
// NewDraftServiceInterface creates an initializes a DraftServiceInterface.
func NewDraftServiceInterface(cli *soap.Client) DraftServiceInterface {
	return &draftServiceInterface{cli}
}

// DraftServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type DraftServiceInterface interface {
	// Returns a DraftPage that contains a list of Draft objects matching
	// the selector.                  @throws {#link com.google.ads.api.services.common.error.ApiException}
	...
	// the life cycle of Drafts,         such as abandoning or promoting
	// Drafts.                  @return The list of updated Drafts,
	// in the same order as the {@code operations} list.         @throws
	// {#link com.google.ads.api.services.common.error.ApiException}
	// if problems occurred         while processing the request.
	Mutate(Mutate *Mutate) (*MutateResponse, error)

	// Returns a DraftPage that contains a list of Draft objects matching
	// the query.                  @throws {#link com.google.ads.api.services.common.error.ApiException}
	// if problems occurred         while retrieving the results.
...
// DraftErrorReason was auto-generated from WSDL.
type DraftErrorReason string

// Validate validates DraftErrorReason.
func (v DraftErrorReason) Validate() bool {
	for _, vv := range []string{
...
// DraftStatus was auto-generated from WSDL.
type DraftStatus string

// Validate validates DraftStatus.
func (v DraftStatus) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
		"PROPOSED",
		"PROMOTED",
...
type DateRange struct {
	Min *Date `xml:"min,omitempty" json:"min,omitempty" yaml:"min,omitempty"`
	Max *Date `xml:"max,omitempty" json:"max,omitempty" yaml:"max,omitempty"`
}
...
// The interface object which contains the basic information of
// a draft.  Entity specific             information in the campaign
// tree are represented by their respective entities objects with
// a             corresponding draftId.
type Draft struct {
	...
	DraftName       *string      `xml:"draftName,omitempty" json:"draftName,omitempty" yaml:"draftName,omitempty"`
	DraftStatus     *DraftStatus `xml:"draftStatus,omitempty" json:"draftStatus,omitempty" yaml:"draftStatus,omitempty"`
	DraftCampaignId *int64       `xml:"draftCampaignId,omitempty" json:"draftCampaignId,omitempty" yaml:"draftCampaignId,omitempty"`
	HasRunningTrial *bool        `xml:"hasRunningTrial,omitempty" json:"hasRunningTrial,omitempty" yaml:"hasRunningTrial,omitempty"`
}
...
type DraftError struct {
	...
	ErrorString       *string             `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string             `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *DraftErrorReason   `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string              `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string              `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *DraftError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:DraftError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type DraftOperation struct {
	...
	Operand       *Draft    `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string    `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string    `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *DraftOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:DraftOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// Contains a subset of drafts resulting from the filtering and
// paging of             {@link DraftService#get} call.
type DraftPage struct {
	...
	Entries         []*Draft `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string   `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string   `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *DraftPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:DraftPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// A container for return values from a {@DraftService#mutate}
// call.
type DraftReturnValue struct {
	...
	Value               []*Draft `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
	TypeAttrXSI         string   `xml:"xsi:type,attr,omitempty"`
	TypeNamespace       string   `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *DraftReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:DraftReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *DraftPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*DraftOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *DraftReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// draftServiceInterface implements the DraftServiceInterface interface.
...
// the selector.                  @throws {#link com.google.ads.api.services.common.error.ApiException}
// if problems occurred         while retrieving the results.
func (p *draftServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// {#link com.google.ads.api.services.common.error.ApiException}
// if problems occurred         while processing the request.
func (p *draftServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// the query.                  @throws {#link com.google.ads.api.services.common.error.ApiException}
// if problems occurred         while retrieving the results.
func (p *draftServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
