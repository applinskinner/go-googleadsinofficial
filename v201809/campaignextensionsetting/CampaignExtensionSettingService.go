package campaignextensionsetting
...
// NewCampaignExtensionSettingServiceInterface creates an initializes a CampaignExtensionSettingServiceInterface.
func NewCampaignExtensionSettingServiceInterface(cli *soap.Client) CampaignExtensionSettingServiceInterface {
	return &campaignExtensionSettingServiceInterface{cli}
}

// CampaignExtensionSettingServiceInterface was auto-generated from WSDL
...
type CampaignExtensionSettingServiceInterface interface {
	...
	// CampaignExtensionSettings to return. If empty, all         CampaignExtensionSettings
	// are returned.         @return The list of CampaignExtensionSettings
	...
	// on a campaign with an existing ExtensionSetting will cause the
	// operation to be         treated like a set operation. Performing
	// a set operation on a campaign with no         ExtensionSetting
	// will cause the operation to be treated like an add operation.
	//                  @param operations The operations to apply.
	// The same {@link CampaignExtensionSetting} cannot be
	// specified in more than one operation.         @return The changed
	// {@link CampaignExtensionSetting}s.         @throws ApiException
	...
	//         @return The list of CampaignExtensionSettings specified
...
// being served for the specified             campaign.
...
type CampaignExtensionSettingOperation struct {
	...
	Operand       *CampaignExtensionSetting `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string                    `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string                    `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignExtensionSettingOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignExtensionSettingOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// from a             {@code CampaignExtensionSettingService#get}
// call.
type CampaignExtensionSettingPage struct {
	...
	Entries         []*CampaignExtensionSetting `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string                      `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string                      `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignExtensionSettingPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignExtensionSettingPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type CampaignExtensionSettingReturnValue struct {
	...
	Value                []*CampaignExtensionSetting `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignExtensionSettingReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignExtensionSettingReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *CampaignExtensionSettingPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*CampaignExtensionSettingOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *CampaignExtensionSettingReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// campaignExtensionSettingServiceInterface implements the CampaignExtensionSettingServiceInterface interface.
...
// specified by the selector.         @throws ApiException Indicates
// a problem with the request.
func (p *campaignExtensionSettingServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// {@link CampaignExtensionSetting}s.         @throws ApiException
// Indicates a problem with the request.
func (p *campaignExtensionSettingServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// by the query.         @throws ApiException Indicates a problem
// with the request.
func (p *campaignExtensionSettingServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
