...
// NewTrialServiceInterface creates an initializes a TrialServiceInterface.
func NewTrialServiceInterface(cli *soap.Client) TrialServiceInterface {
	return &trialServiceInterface{cli}
}

// TrialServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type TrialServiceInterface interface {
	// Loads a TrialPage containing a list of {@link Trial} objects
	// matching the selector.                  @param selector defines
	// which subset of all available trials to return, the sort order,
	// and         which fields to include                  @return
	// Returns a page of matching trial objects.         @throws com.google.ads.api.services.common.error.ApiException
	// if errors occurred while         retrieving the results.
	Get(Get *Get) (*GetResponse, error)

	// Creates new trials, updates properties and controls the life
	// cycle of existing trials.         See {@link TrialService} for
	// details on the trial life cycle.                  @return Returns
	// the list of updated Trials, in the same order as the {@code
	// operations} list.         @throws com.google.ads.api.services.common.error.ApiException
	// if errors occurred while         processing the request.
	Mutate(Mutate *Mutate) (*MutateResponse, error)

	// Loads a TrialPage containing a list of {@link Trial} objects
	// matching the query.                  @param query defines which
	// subset of all available trials to return, the sort order, and
	//         which fields to include                  @return Returns
	// a page of matching trial objects.         @throws com.google.ads.api.services.common.error.ApiException
	// if errors occurred while         retrieving the results.
...
// CampaignTrialTrafficSplitType was auto-generated from WSDL.
type CampaignTrialTrafficSplitType string

// Validate validates CampaignTrialTrafficSplitType.
func (v CampaignTrialTrafficSplitType) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
		"RANDOM_QUERY",
		"COOKIE",
...
// TrialErrorReason was auto-generated from WSDL.
type TrialErrorReason string

// Validate validates TrialErrorReason.
func (v TrialErrorReason) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
...
// TrialStatus was auto-generated from WSDL.
type TrialStatus string

// Validate validates TrialStatus.
func (v TrialStatus) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
		"CREATING",
		"ACTIVE",
...
// created by an advertiser from             changes in a draft.
type Trial struct {
	...
	DraftId             *int64                         `xml:"draftId,omitempty" json:"draftId,omitempty" yaml:"draftId,omitempty"`
	...
	TrafficSplitPercent *int                           `xml:"trafficSplitPercent,omitempty" json:"trafficSplitPercent,omitempty" yaml:"trafficSplitPercent,omitempty"`
	TrafficSplitType    *CampaignTrialTrafficSplitType `xml:"trafficSplitType,omitempty" json:"trafficSplitType,omitempty" yaml:"trafficSplitType,omitempty"`
	Status              *TrialStatus                   `xml:"status,omitempty" json:"status,omitempty" yaml:"status,omitempty"`
...
type TrialError struct {
	...
	ErrorString       *string             `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string             `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *TrialErrorReason   `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string              `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string              `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *TrialError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:TrialError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type TrialOperation struct {
	...
	Operand       *Trial    `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string    `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string    `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *TrialOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:TrialOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type TrialPage struct {
	...
	Entries         []*Trial `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string   `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string   `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *TrialPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:TrialPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// Return value for {@link TrialService#mutate(java.util.List)}
// operations.
type TrialReturnValue struct {
	...
	Value                []*Trial    `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *TrialReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:TrialReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *TrialPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*TrialOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *TrialReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// trialServiceInterface implements the TrialServiceInterface interface.
...
// Returns a page of matching trial objects.         @throws com.google.ads.api.services.common.error.ApiException
// if errors occurred while         retrieving the results.
func (p *trialServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// operations} list.         @throws com.google.ads.api.services.common.error.ApiException
// if errors occurred while         processing the request.
func (p *trialServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// a page of matching trial objects.         @throws com.google.ads.api.services.common.error.ApiException
// if errors occurred while         retrieving the results.
func (p *trialServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
