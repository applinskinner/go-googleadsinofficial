package customerextensionsetting
...
// NewCustomerExtensionSettingServiceInterface creates an initializes a CustomerExtensionSettingServiceInterface.
func NewCustomerExtensionSettingServiceInterface(cli *soap.Client) CustomerExtensionSettingServiceInterface {
	return &customerExtensionSettingServiceInterface{cli}
}

// CustomerExtensionSettingServiceInterface was auto-generated from WSDL
...
type CustomerExtensionSettingServiceInterface interface {
	...
	// CustomerExtensionSettings to return. If empty, all         CustomerExtensionSettings
	// are returned.         @return The list of CustomerExtensionSettings
	...
	// when there is an existing ExtensionSetting will cause the operation
	// to be         treated like a set operation. Performing a set
	// operation when there is no existing         ExtensionSetting
	// will cause the operation to be treated like an add operation.
	//                  @param operations The operations to apply.
	// The same {@link CustomerExtensionSetting} cannot be
	// specified in more than one operation.         @return The changed
	// {@link CustomerExtensionSetting}s.         @throws ApiException
	...
	//         @return The list of CustomerExtensionSettings specified
...
type CustomerExtensionSettingOperation struct {
	...
	Operand       *CustomerExtensionSetting `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string                    `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string                    `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CustomerExtensionSettingOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CustomerExtensionSettingOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// from a             {@code CustomerExtensionSettingService#get}
// call.
type CustomerExtensionSettingPage struct {
	...
	Entries         []*CustomerExtensionSetting `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string                      `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string                      `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CustomerExtensionSettingPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CustomerExtensionSettingPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type CustomerExtensionSettingReturnValue struct {
	...
	Value                []*CustomerExtensionSetting `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CustomerExtensionSettingReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CustomerExtensionSettingReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *CustomerExtensionSettingPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*CustomerExtensionSettingOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *CustomerExtensionSettingReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// customerExtensionSettingServiceInterface implements the CustomerExtensionSettingServiceInterface interface.
...
// specified by the selector.         @throws ApiException Indicates
// a problem with the request.
func (p *customerExtensionSettingServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// {@link CustomerExtensionSetting}s.         @throws ApiException
// Indicates a problem with the request.
func (p *customerExtensionSettingServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// by the query.         @throws ApiException Indicates a problem
// with the request.
func (p *customerExtensionSettingServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
