...
// NewCampaignBidModifierServiceInterface creates an initializes a CampaignBidModifierServiceInterface.
func NewCampaignBidModifierServiceInterface(cli *soap.Client) CampaignBidModifierServiceInterface {
	return &campaignBidModifierServiceInterface{cli}
}

// CampaignBidModifierServiceInterface was auto-generated from WSDL
...
type CampaignBidModifierServiceInterface interface {
	...
	// criteria.                  @param selector specifying the {@link
	// CampaignBidModifier}s to return.         @return A list of campaign
	// bid modifiers.         @throws ApiException if problems occurred
	// while fetching campaign bid modifier information.
	Get(Get *Get) (*GetResponse, error)

	// Adds, updates, or deletes campaign bid modifiers.
	//        @param operations A list of unique operations.
	//   @return The list of updated campaign bid modifiers, returned
	// in the same order as the <code>         operations</code> array.
...
type CampaignBidModifierOperation struct {
	...
	Operand       *CampaignBidModifier `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string               `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string               `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignBidModifierOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignBidModifierOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type CampaignBidModifierPage struct {
	...
	Entries         []*CampaignBidModifier `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string                 `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string                 `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignBidModifierPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignBidModifierPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type CampaignBidModifierReturnValue struct {
	...
	Value                []*CampaignBidModifier `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *CampaignBidModifierReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:CampaignBidModifierReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// ID.             <span class="constraint AdxEnabled">This is
...
// SetXMLType was auto-generated from WSDL.
func (t *InteractionType) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:InteractionType"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *CampaignBidModifierPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*CampaignBidModifierOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *CampaignBidModifierReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// campaignBidModifierServiceInterface implements the CampaignBidModifierServiceInterface interface.
...
// bid modifiers.         @throws ApiException if problems occurred
// while fetching campaign bid modifier information.
func (p *campaignBidModifierServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
//         @throws ApiException if problems occurred while updating
// campaign bid modifiers information.
func (p *campaignBidModifierServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// string.         @throws ApiException when there are one or more
// errors with the request.
func (p *campaignBidModifierServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
