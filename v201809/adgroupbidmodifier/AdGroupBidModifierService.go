...
// NewAdGroupBidModifierServiceInterface creates an initializes a AdGroupBidModifierServiceInterface.
func NewAdGroupBidModifierServiceInterface(cli *soap.Client) AdGroupBidModifierServiceInterface {
	return &adGroupBidModifierServiceInterface{cli}
}

// AdGroupBidModifierServiceInterface was auto-generated from WSDL
...
type AdGroupBidModifierServiceInterface interface {
	...
	// to return.         @return A list of ad group bid modifiers.
	...
	//      @throws ApiException when there is at least one error with
	// the request.
	...
	// string.         @throws ApiException when there are one or more
...
// BidModifierSource was auto-generated from WSDL.
type BidModifierSource string

// Validate validates BidModifierSource.
func (v BidModifierSource) Validate() bool {
	for _, vv := range []string{
		"UNKNOWN",
		"CAMPAIGN",
		"AD_GROUP",
...
// level criterion             bid modifier values.
type AdGroupBidModifier struct {
	...
	BidModifierSource *BidModifierSource `xml:"bidModifierSource,omitempty" json:"bidModifierSource,omitempty" yaml:"bidModifierSource,omitempty"`
}

// Operation used to create or mutate a AdGroupBidModifier.
//                       <p>If you try to ADD a criterion that
// already exists, it will be treated as a SET operation
...
type AdGroupBidModifierOperation struct {
	...
	Operand       *AdGroupBidModifier `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
...
func (t *AdGroupBidModifierOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:AdGroupBidModifierOperation"
	}
...
// Contains a subset of adgroup bid modifiers resulting from a
// call to             {@link AdGroupBidModifierService#get}.
type AdGroupBidModifierPage struct {
	...
	Entries         []*AdGroupBidModifier `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string                `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string                `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *AdGroupBidModifierPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:AdGroupBidModifierPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type AdGroupBidModifierReturnValue struct {
	...
	Value                []*AdGroupBidModifier `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *AdGroupBidModifierReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:AdGroupBidModifierReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// using an ID.             <span class="constraint AdxEnabled">This
...
// SetXMLType was auto-generated from WSDL.
func (t *PreferredContent) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:PreferredContent"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *AdGroupBidModifierPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*AdGroupBidModifierOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *AdGroupBidModifierReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// adGroupBidModifierServiceInterface implements the AdGroupBidModifierServiceInterface interface.
...
//         @throws ApiException when there is at least one error
// with the request.
func (p *adGroupBidModifierServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
//      @throws ApiException when there is at least one error with
// the request.
func (p *adGroupBidModifierServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
// string.         @throws ApiException when there are one or more
// errors with the request.
func (p *adGroupBidModifierServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
