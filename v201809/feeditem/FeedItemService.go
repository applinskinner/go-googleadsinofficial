...
// NewFeedItemServiceInterface creates an initializes a FeedItemServiceInterface.
func NewFeedItemServiceInterface(cli *soap.Client) FeedItemServiceInterface {
	return &feedItemServiceInterface{cli}
}

// FeedItemServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type FeedItemServiceInterface interface {
	// Returns a list of FeedItems that meet the selector criteria.
	//                  @param selector Determines which FeedItems
	// to return. If empty all         FeedItems are returned.
	//     @return The list of FeedItems.         @throws ApiException
	// Indicates a problem with the request.
	Get(Get *Get) (*GetResponse, error)

	// Add, remove, and set FeedItems.                  @param operations
	// The operations to apply.         @return The resulting FeedItems.
	//         @throws ApiException Indicates a problem with the request.
	Mutate(Mutate *Mutate) (*MutateResponse, error)

	// Returns the list of FeedItems that match the query.
	//          @param query The SQL-like AWQL query string
	//  @returns A list of FeedItems         @throws ApiException when
...
// FeedItemErrorReason was auto-generated from WSDL.
type FeedItemErrorReason string

// Validate validates FeedItemErrorReason.
func (v FeedItemErrorReason) Validate() bool {
	for _, vv := range []string{
...
type FeedItem struct {
	...
	AttributeValues         []*FeedItemAttributeValue `xml:"attributeValues,omitempty" json:"attributeValues,omitempty" yaml:"attributeValues,omitempty"`
...
// A feed item's value is             composed of a collection
...
type FeedItemAttributeValue struct {
	...
	IntegerValue           *int64             `xml:"integerValue,omitempty" json:"integerValue,omitempty" yaml:"integerValue,omitempty"`
	...
	IntegerValues          []*int64           `xml:"integerValues,omitempty" json:"integerValues,omitempty" yaml:"integerValues,omitempty"`
	DoubleValues           []*float64         `xml:"doubleValues,omitempty" json:"doubleValues,omitempty" yaml:"doubleValues,omitempty"`
	BooleanValues          []*bool            `xml:"booleanValues,omitempty" json:"booleanValues,omitempty" yaml:"booleanValues,omitempty"`
	StringValues           []*string          `xml:"stringValues,omitempty" json:"stringValues,omitempty" yaml:"stringValues,omitempty"`
	MoneyWithCurrencyValue *MoneyWithCurrency `xml:"moneyWithCurrencyValue,omitempty" json:"moneyWithCurrencyValue,omitempty" yaml:"moneyWithCurrencyValue,omitempty"`
}
...
type FeedItemError struct {
	...
	ErrorString       *string              `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string              `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *FeedItemErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string               `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string               `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *FeedItemError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:FeedItemError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type FeedItemOperation struct {
	...
	Operand       *FeedItem `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string    `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string    `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *FeedItemOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:FeedItemOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type FeedItemPage struct {
	...
	Entries         []*FeedItem `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
	TypeAttrXSI     string      `xml:"xsi:type,attr,omitempty"`
	TypeNamespace   string      `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *FeedItemPage) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:FeedItemPage"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type FeedItemReturnValue struct {
	...
	Value                []*FeedItem `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *FeedItemReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:FeedItemReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type GetResponse struct {
	Rval *FeedItemPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}

// Mutate was auto-generated from WSDL.
type Mutate struct {
	Operations []*FeedItemOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *FeedItemReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// feedItemServiceInterface implements the FeedItemServiceInterface interface.
...
//     @return The list of FeedItems.         @throws ApiException
// Indicates a problem with the request.
func (p *feedItemServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// The operations to apply.         @return The resulting FeedItems.
//         @throws ApiException Indicates a problem with the request.
func (p *feedItemServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
...
//  @returns A list of FeedItems         @throws ApiException when
// the query is invalid or there are errors processing the request.
func (p *feedItemServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
