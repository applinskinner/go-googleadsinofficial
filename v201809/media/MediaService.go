...
// NewMediaServiceInterface creates an initializes a MediaServiceInterface.
func NewMediaServiceInterface(cli *soap.Client) MediaServiceInterface {
	return &mediaServiceInterface{cli}
}

// MediaServiceInterface was auto-generated from WSDL
// and defines interface for the remote service. Useful for testing.
type MediaServiceInterface interface {
	// Returns a list of media that meet the criteria specified by
	// the selector.         <p class="note"><b>Note:</b> {@code MediaService}
	// will not return any         {@link ImageAd} image files.</p>
	//                  @param serviceSelector Selects which media
	// objects to return.         @return A list of {@code Media} objects.
	Get(Get *Get) (*GetResponse, error)

	// Returns the list of {@link Media} objects that match the query.
	//                  @param query The SQL-like AWQL query string
	//         @returns A list of {@code Media} objects.         @throws
	// ApiException when the query is invalid or there are errors processing
	// the request.
	Query(Query string) (*QueryResponse, error)

	// Uploads new media. Currently, you can upload {@link Image} files
	// and {@link MediaBundle}s.                  @param media A list
	// of {@code Media} objects, each containing the data to
	//   be uploaded.         @return A list of uploaded media in the
	// same order as the argument list.
	Upload(Upload *Upload) (*UploadResponse, error)
}

// AudioErrorReason was auto-generated from WSDL.
type AudioErrorReason string

// Validate validates AudioErrorReason.
func (v AudioErrorReason) Validate() bool {
...
type AudioError struct {
	...
	Reason            *AudioErrorReason   `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string              `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string              `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *AudioError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:AudioError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type MediaPage struct {
	Entries         []*Media `xml:"entries,omitempty" json:"entries,omitempty" yaml:"entries,omitempty"`
...
type GetResponse struct {
	Rval *MediaPage `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
type Upload struct {
	Media []*Media `xml:"media,omitempty" json:"media,omitempty" yaml:"media,omitempty"`
}

// UploadResponse was auto-generated from WSDL.
type UploadResponse struct {
	Rval []*Media `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// Operation wrapper for Upload.
// OperationUploadRequest was auto-generated from WSDL.
type OperationUploadRequest struct {
	Upload *Upload `xml:"upload,omitempty" json:"upload,omitempty" yaml:"upload,omitempty"`
}

// Operation wrapper for Upload.
// OperationUploadResponse was auto-generated from WSDL.
type OperationUploadResponse struct {
	UploadResponse *UploadResponse `xml:"uploadResponse,omitempty" json:"uploadResponse,omitempty" yaml:"uploadResponse,omitempty"`
}

// mediaServiceInterface implements the MediaServiceInterface interface.
...
//                  @param serviceSelector Selects which media
// objects to return.         @return A list of {@code Media} objects.
func (p *mediaServiceInterface) Get(Get *Get) (*GetResponse, error) {
	α := struct {
...
// ApiException when the query is invalid or there are errors processing
// the request.
func (p *mediaServiceInterface) Query(Query string) (*QueryResponse, error) {
	α := struct {
...
//   be uploaded.         @return A list of uploaded media in the
// same order as the argument list.
func (p *mediaServiceInterface) Upload(Upload *Upload) (*UploadResponse, error) {
	α := struct {
		OperationUploadRequest `xml:"tns:upload"`
	}{
		OperationUploadRequest{
			Upload,
		},
	}

	γ := struct {
		OperationUploadResponse `xml:"uploadResponse"`
	}{}
	if err := p.cli.RoundTripWithAction("Upload", α, &γ); err != nil {
		return nil, err
	}
	return γ.UploadResponse, nil
}
