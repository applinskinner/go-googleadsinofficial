package offlinecallconversionfeed
...
// NewOfflineCallConversionFeedServiceInterface creates an initializes a OfflineCallConversionFeedServiceInterface.
func NewOfflineCallConversionFeedServiceInterface(cli *soap.Client) OfflineCallConversionFeedServiceInterface {
	return &offlineCallConversionFeedServiceInterface{cli}
}

// OfflineCallConversionFeedServiceInterface was auto-generated from WSDL
...
type OfflineCallConversionFeedServiceInterface interface {
	...
	//                  <p>This bulk operation does not have any transactional
	// guarantees. Some operations can succeed         while others
	// fail.                  <p><b>Note:</b> {@link OfflineCallConversionFeedOperation}
	// supports only the         {@code ADD} operator. ({@code SET}
	// and {@code REMOVE} are not supported.)                  @param
	// operations A list of offline call conversion feed operations.
	//         @return The list of offline call conversion feed results
	// (in the same order as the operations).         @throws {@link
	// ApiException} if problems occurred while applying offline call
	// conversions.
...
// OfflineCallConversionErrorReason was auto-generated from WSDL.
type OfflineCallConversionErrorReason string

// Validate validates OfflineCallConversionErrorReason.
func (v OfflineCallConversionErrorReason) Validate() bool {
	for _, vv := range []string{
...
// OfflineConversionErrorReason was auto-generated from WSDL.
type OfflineConversionErrorReason string

// Validate validates OfflineConversionErrorReason.
func (v OfflineConversionErrorReason) Validate() bool {
	for _, vv := range []string{
		"UNPARSEABLE_GCLID",
...
// Errors that the {@link OfflineCallConversionFeedService} can
// throw.
type OfflineCallConversionError struct {
	...
	ErrorString       *string                           `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string                           `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *OfflineCallConversionErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string                            `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string                            `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *OfflineCallConversionError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:OfflineCallConversionError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
// Represents an entire record in the offline call conversions
// feed that the advertiser uploads.
type OfflineCallConversionFeed struct {
	CallerId               *string  `xml:"callerId,omitempty" json:"callerId,omitempty" yaml:"callerId,omitempty"`
	CallStartTime          *string  `xml:"callStartTime,omitempty" json:"callStartTime,omitempty" yaml:"callStartTime,omitempty"`
	ConversionName         *string  `xml:"conversionName,omitempty" json:"conversionName,omitempty" yaml:"conversionName,omitempty"`
	ConversionTime         *string  `xml:"conversionTime,omitempty" json:"conversionTime,omitempty" yaml:"conversionTime,omitempty"`
	ConversionValue        *float64 `xml:"conversionValue,omitempty" json:"conversionValue,omitempty" yaml:"conversionValue,omitempty"`
	ConversionCurrencyCode *string  `xml:"conversionCurrencyCode,omitempty" json:"conversionCurrencyCode,omitempty" yaml:"conversionCurrencyCode,omitempty"`
}

// Operation for uploading {@link OfflineCallConversionFeed}.
//            See {@link OfflineCallConversionFeedService#mutate}.
//                          <p><b>Note:</b> Only the {@code ADD}
...
type OfflineCallConversionFeedOperation struct {
	...
	Operand       *OfflineCallConversionFeed `xml:"operand,omitempty" json:"operand,omitempty" yaml:"operand,omitempty"`
	TypeAttrXSI   string                     `xml:"xsi:type,attr,omitempty"`
	TypeNamespace string                     `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *OfflineCallConversionFeedOperation) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:OfflineCallConversionFeedOperation"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type OfflineCallConversionFeedReturnValue struct {
	...
	Value                []*OfflineCallConversionFeed `xml:"value,omitempty" json:"value,omitempty" yaml:"value,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *OfflineCallConversionFeedReturnValue) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:OfflineCallConversionFeedReturnValue"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type OfflineConversionError struct {
	...
	ErrorString       *string                       `xml:"errorString,omitempty" json:"errorString,omitempty" yaml:"errorString,omitempty"`
	ApiErrorType      *string                       `xml:"ApiError.Type,omitempty" json:"ApiError.Type,omitempty" yaml:"ApiError.Type,omitempty"`
	Reason            *OfflineConversionErrorReason `xml:"reason,omitempty" json:"reason,omitempty" yaml:"reason,omitempty"`
	TypeAttrXSI       string                        `xml:"xsi:type,attr,omitempty"`
	TypeNamespace     string                        `xml:"xmlns:objtype,attr,omitempty"`
...
// SetXMLType was auto-generated from WSDL.
func (t *OfflineConversionError) SetXMLType() {
	if t.OverrideTypeAttrXSI != nil {
		t.TypeAttrXSI = *t.OverrideTypeAttrXSI
	} else {
		t.TypeAttrXSI = "objtype:OfflineConversionError"
	}
	if t.OverrideTypeNamespace != nil {
		t.TypeNamespace = *t.OverrideTypeNamespace
	} else {
...
type Mutate struct {
	Operations []*OfflineCallConversionFeedOperation `xml:"operations,omitempty" json:"operations,omitempty" yaml:"operations,omitempty"`
}

// MutateResponse was auto-generated from WSDL.
type MutateResponse struct {
	Rval *OfflineCallConversionFeedReturnValue `xml:"rval,omitempty" json:"rval,omitempty" yaml:"rval,omitempty"`
}
...
// offlineCallConversionFeedServiceInterface implements the OfflineCallConversionFeedServiceInterface interface.
...
// ApiException} if problems occurred while applying offline call
// conversions.
func (p *offlineCallConversionFeedServiceInterface) Mutate(Mutate *Mutate) (*MutateResponse, error) {
	α := struct {
